...
* of a Movie Graph Pipeline. After creating a UMovieGraphExecuteScriptNode and
* choosing the type of your script, at runtime, an instance will be created when
...
* with a Script Node, and set it to run MovieGraphPipelineScriptExample. When
* the job is run, the output console should print "OnJobStart" as a warning.
...
public:
	...
	*/
	UFUNCTION(BlueprintNativeEvent, Category = "Movie Graph")
	void OnJobFinished(UMoviePipelineExecutorJob* InJobCopy, const FMovieGraphPipelineOutputData& InOutputData);
	virtual void OnJobFinished_Implementation(UMoviePipelineExecutorJob* InJobCopy, const FMovieGraphPipelineOutputData& InOutputData ) {}
	...
	*/
	UFUNCTION(BlueprintNativeEvent, Category = "Movie Graph")
	void OnShotFinished(UMoviePipelineExecutorJob* InJobCopy, UMoviePipelineExecutorShot* InShotCopy, const FMovieGraphPipelineOutputData& OutputData);
	virtual void OnShotFinished_Implementation(UMoviePipelineExecutorJob* InJobCopy, UMoviePipelineExecutorShot* InShotCopy, const FMovieGraphPipelineOutputData& OutputData) {}
