...
UMovieGraphCoreRenderPassNode::UMovieGraphCoreRenderPassNode()
{
...
TArray<uint32> UMovieGraphCoreRenderPassNode::GetDefaultShowFlags() const
{
...
{
	FEngineShowFlags NewShowFlags = Cast<UMovieGraphCoreRenderPassNode>(LayerData.RenderPassNode)->GetShowFlags();
	const EViewModeIndex ViewModeIndex = Cast<UMovieGraphCoreRenderPassNode>(LayerData.RenderPassNode)->GetViewModeIndex();
