...
{
	UE::MovieGraph::Private::RefreshVariableAssignments(GraphPreset.LoadSynchronous(), VariableAssignments, this);
...
TObjectPtr<UMovieJobVariableAssignmentContainer> UMoviePipelineExecutorJob::GetOrCreateJobVariableAssignmentsForGraph(const UMovieGraphConfig* InGraph)
{
	if (InGraph)
	{
		return UE::MovieGraph::Private::GetOrCreateJobVariableAssignmentsForGraph(InGraph, VariableAssignments, this);
	}
...
TObjectPtr<UMovieJobVariableAssignmentContainer> UMoviePipelineExecutorShot::GetOrCreateJobVariableAssignmentsForGraph(const UMovieGraphConfig* InGraph, const bool bIsForPrimaryOverrides)
{
	if (InGraph)
	{
		return UE::MovieGraph::Private::GetOrCreateJobVariableAssignmentsForGraph(InGraph, bIsForPrimaryOverrides ? PrimaryGraphVariableAssignments : VariableAssignments, this);
	}
