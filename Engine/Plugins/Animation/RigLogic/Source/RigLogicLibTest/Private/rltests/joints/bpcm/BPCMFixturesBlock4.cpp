...
const Vector<Vector<bpcm::JointGroup> > jointGroups = {
    ...
    {  // Quaternion outputs
        {  // Joint group 0
            0, 0, 0, 0, 0, 0, 52, 13, 12, 8
        },
        {  // Joint group 1
            52, 13, 4, 4, 0, 4, 52, 13, 12, 8
        },
        {  // Joint group 2
            104, 26, 8, 8, 1, 8, 104, 13, 12, 8
        },
        {  // Joint group 3
            208, 39, 16, 12, 2, 12, 104, 13, 12, 8
        },
        {  // Joint group 4
            312, 52, 24, 16, 3, 16, 156, 13, 12, 8
        },
        {  // Joint group 5
            468, 65, 36, 20, 4, 20, 156, 13, 12, 8
        },
        {  // Joint group 6
            624, 78, 48, 24, 5, 24, 208, 13, 12, 8
        },
        {  // Joint group 7
            832, 91, 64, 28, 7, 28, 208, 13, 12, 8
        },
        {  // Joint group 8
            1040, 104, 80, 32, 9, 32, 208, 13, 12, 8
        },
        {  // Joint group 9
            1248, 117, 96, 36, 11, 36, 20, 5, 4, 0
        },
        {  // Joint group 10
    ...
    {  // Euler-angle outputs
        ...
        {  // Joint group 1
            52, 13, 4, 4, 0, 0, 52, 13, 12, 8
        },
        {  // Joint group 2
            104, 26, 8, 8, 0, 0, 104, 13, 12, 8
        },
        {  // Joint group 3
            208, 39, 16, 12, 0, 0, 104, 13, 12, 8
        },
        {  // Joint group 4
            312, 52, 24, 16, 0, 0, 156, 13, 12, 8
        },
        {  // Joint group 5
            468, 65, 36, 20, 0, 0, 156, 13, 12, 8
        },
        {  // Joint group 6
            624, 78, 48, 24, 0, 0, 208, 13, 12, 8
        },
        {  // Joint group 7
            832, 91, 64, 28, 0, 0, 208, 13, 12, 8
        },
        {  // Joint group 8
            1040, 104, 80, 32, 0, 0, 208, 13, 12, 8
        },
        {  // Joint group 9
            1248, 117, 96, 36, 0, 0, 20, 5, 4, 0
        },
        {  // Joint group 10
