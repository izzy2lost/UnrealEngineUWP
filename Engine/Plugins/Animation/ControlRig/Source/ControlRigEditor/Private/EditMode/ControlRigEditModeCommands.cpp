...
void FControlRigEditModeCommands::RegisterCommands()
{
	...
	UI_COMMAND(InvertInputPose, "Invert Input Pose", "Invert Input Pose for additive control rigs", EUserInterfaceActionType::Button, FInputChord(EKeys::I, EModifierKey::Control));
