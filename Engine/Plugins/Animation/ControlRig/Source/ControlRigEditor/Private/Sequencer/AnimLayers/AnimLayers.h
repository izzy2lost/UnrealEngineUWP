...
struct FAnimLayerPropertyAndChannels
{
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Data", meta = (Bitmask, BitmaskEnum = EControlRigContextChannelToKey))
	int32 Channels;
};
...
struct FAnimLayerState
{
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Data", meta = (Bitmask, BitmaskEnum = EAnimLayerType))
	mutable int32 Type;
