...
public:
	...
	{
	public:
		FScopedBulkDataMemoryReader(const int64 InOffset, const int32 InBytesToRead, FLiveLinkHubBulkData* InBulkData);

		/** Retrieve the memory reader. */
		FMemoryReader& GetMemoryReader() const { return *MemoryReader; }
