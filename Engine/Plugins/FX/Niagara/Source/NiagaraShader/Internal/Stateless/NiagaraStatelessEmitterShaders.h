...
namespace NiagaraStateless
{
	...
	public:
		...
		BEGIN_SHADER_PARAMETER_STRUCT(FParameters, NIAGARASHADER_API)
			...
			SHADER_PARAMETER_STRUCT_INCLUDE(FCameraOffsetModule_ShaderParameters,				Module4Params)
			SHADER_PARAMETER_STRUCT_INCLUDE(FScaleColorModule_ShaderParameters,					Module5Params)
			SHADER_PARAMETER_STRUCT_INCLUDE(FScaleSpriteSizeModule_ShaderParameters,			Module6Params)
			SHADER_PARAMETER_STRUCT_INCLUDE(FScaleSpriteSizeBySpeedModule_ShaderParameters,		Module7Params)
			SHADER_PARAMETER_STRUCT_INCLUDE(FScaleMeshSizeModule_ShaderParameters,				Module8Params)
			SHADER_PARAMETER_STRUCT_INCLUDE(FScaleMeshSizeBySpeedModule_ShaderParameters,		Module9Params)
			SHADER_PARAMETER_STRUCT_INCLUDE(FMeshRotationRateModule_ShaderParameters,			Module10Params)
			SHADER_PARAMETER_STRUCT_INCLUDE(FSolveVelocitiesAndForcesModule_ShaderParameters,	Module11Params)
			SHADER_PARAMETER_STRUCT_INCLUDE(FSpriteFacingAndAlignmentModule_ShaderParameters,	Module12Params)
			SHADER_PARAMETER_STRUCT_INCLUDE(FSpriteRotationRateModule_ShaderParameters,			Module13Params)
			SHADER_PARAMETER_STRUCT_INCLUDE(FSubUVAnimationModule_ShaderParameters,				Module14Params)
			SHADER_PARAMETER_STRUCT_INCLUDE(FDynamicMaterialParametersModule_ShaderParameters,	Module15Params)
