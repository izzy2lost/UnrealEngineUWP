...
void FNiagaraEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(ToggleStatelessInfo, "Stateless", "Show information about stateless emitters and execution path", EUserInterfaceActionType::ToggleButton, FInputChord());
