...
void UTedsAssetDataFactory::RegisterQueries(ITypedElementDataStorageInterface& DataStorage)
{
...
void UTedsAssetDataFactory::PreRegister(ITypedElementDataStorageInterface& DataStorage)
{
...
void UTedsAssetDataFactory::PreShutdown(ITypedElementDataStorageInterface& DataStorage)
{
	if (FContentBrowserModule* ContentBrowserModule = FModuleManager::Get().GetModulePtr<FContentBrowserModule>("ContentBrowser"))
	{
...
void UTedsAssetDataFactory::OnSetFolderColor(const FString& Path, ITypedElementDataStorageInterface* DataStorage)
{
