...
PHYSICSCONTROL_API void CollectOperatorNames(const FAnimNode_RigidBodyWithControl* const Node, TMap<FName, FPhysicsControlLimbBones> AllLimbBones, const FReferenceSkeleton& RefSkeleton, UPhysicsAsset* const PhysicsAsset, TSet<FName>& BodyModifierNames, TSet<FName>& ControlNames, FRigidBodyNameRecords& NameRecords);

// Creates the body modifiers, controls and sets for the supplied node, limb bones, skeleton and physics asset.
PHYSICSCONTROL_API void CreateOperatorsForNode(FAnimNode_RigidBodyWithControl* const Node, TMap<FName, FPhysicsControlLimbBones> AllLimbBones, const FReferenceSkeleton& RefSkeleton, UPhysicsAsset* const PhysicsAsset, FRigidBodyNameRecords& NameRecords);

// Adds the specified additional sets to the supplied Name Records structure.
PHYSICSCONTROL_API void CreateAdditionalSets(const FPhysicsControlSetUpdates& AdditionalSets, const TSet<FName>& BodyModifierNames, const TSet<FName>& ControlNames, FRigidBodyNameRecords& NameRecords);

// Adds the specified additional sets to the supplied Name Records structure.
PHYSICSCONTROL_API void CreateAdditionalSets(const FPhysicsControlSetUpdates& AdditionalSets, const TMap<FName, FRigidBodyModifierRecord>& BodyModifierNames, const TMap<FName, FRigidBodyControlRecord>& ControlNames, FRigidBodyNameRecords& NameRecords);
