...
UCLASS()
class OPERATORSTACKEDITOR_API UOperatorStackEditorSubsystem : public UEditorSubsystem
{
	GENERATED_BODY()
...
public:
	...
	bool RegisterStackCustomization(TSubclassOf<UOperatorStackEditorStackCustomization> InStackCustomizationClass);
	bool UnregisterStackCustomization(TSubclassOf<UOperatorStackEditorStackCustomization> InStackCustomizationClass);
	...
	bool ForEachCustomizationWidget(TFunctionRef<bool(TSharedRef<SOperatorStackEditorWidget>)> InFunction) const;
