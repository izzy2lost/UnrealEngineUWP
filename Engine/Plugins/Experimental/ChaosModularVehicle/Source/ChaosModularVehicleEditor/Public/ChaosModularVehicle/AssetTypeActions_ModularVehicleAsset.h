...
class FAssetTypeActions_ModularVehicleAsset : public FAssetTypeActions_Base
{
public:
	// IAssetTypeActions Implementation
	virtual FText GetName() const override { return NSLOCTEXT("AssetTypeActions", "AssetTypeActions_ModularVehicleAsset", "ModularVehicle Asset"); }
