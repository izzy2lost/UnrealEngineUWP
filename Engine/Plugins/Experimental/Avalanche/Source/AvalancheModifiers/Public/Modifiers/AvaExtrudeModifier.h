...
class AVALANCHEMODIFIERS_API UAvaExtrudeModifier : public UAvaGeometryBaseModifier
{
	GENERATED_BODY()
...
public:
	...
	bool GetCloseBack() const { return bCloseBack; }

	UFUNCTION()
	void SetExtrudeMode(EAvaExtrudeMode InExtrudeMode);
	EAvaExtrudeMode GetExtrudeMode() const { return ExtrudeMode; }
