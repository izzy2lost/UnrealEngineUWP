...
#include "AvaClonerEffectorShared.generated.h"
...
UENUM(BlueprintType)
enum class EAvaClonerLayout : uint8
{
	Grid,
	Line,
	Circle,
...
UENUM(BlueprintType)
enum class EAvaClonerAxis : uint8
{
	X,
	Y,
	Z,
...
UENUM(BlueprintType)
enum class EAvaClonerPlane : uint8
{
	XY,
	YZ,
	XZ,
...
UENUM(BlueprintType)
enum class EAvaClonerMeshRenderMode : uint8
{
...
UENUM(BlueprintType)
enum class EAvaClonerGridConstraint : uint8
{
	None,
	Sphere,
	Cylinder,
...
UENUM(BlueprintType)
enum class EAvaClonerEasing : uint8
{
	Linear,
...
UENUM(BlueprintType)
enum class EAvaClonerMeshAsset : uint8
{
	StaticMesh,
	SkeletalMesh
};
...
UENUM(BlueprintType)
enum class EAvaClonerMeshSampleData : uint8
{
	Vertices,
	Triangles,
	Sockets,
...
UENUM(BlueprintType)
enum class EAvaClonerEffectorType : uint8
{
...
UENUM(BlueprintType)
enum class EAvaClonerEffectorMode : uint8
{
...
UENUM()
enum class EAvaClonerAttachmentStatus : uint8
{
...
UENUM()
enum class EAvaClonerTextureSampleChannel : uint8
{
	RGBLuminance,
	RGBAverage,
	RGBMax,
...
UENUM()
enum class EAvaClonerCompareMode : uint8
{
	Greater,
	GreaterEqual,
	Equal,
...
UENUM()
enum class EAvaClonerSpawnLoopMode : uint8
{
...
UENUM()
enum class EAvaClonerSpawnBehaviorMode : uint8
{
...
USTRUCT()
struct FAvaClonerAttachmentItem
{
	GENERATED_BODY()
	...
	UPROPERTY()
	EAvaClonerAttachmentStatus MeshStatus = EAvaClonerAttachmentStatus::Outdated;
	...
	UPROPERTY()
	EAvaClonerAttachmentStatus Status = EAvaClonerAttachmentStatus::Outdated;

	friend uint32 GetTypeHash(const FAvaClonerAttachmentItem& InItem)
	{
		return GetTypeHash(InItem.ItemActor);
	}

	bool operator==(const FAvaClonerAttachmentItem& InOther) const
	{
...
USTRUCT()
struct FAvaClonerAttachmentTree
{
	GENERATED_BODY()

	/** All cloner attached actor items */
	UPROPERTY()
	TMap<TWeakObjectPtr<AActor>, FAvaClonerAttachmentItem> ItemAttachmentMap;
	...
	UPROPERTY()
	EAvaClonerAttachmentStatus Status = EAvaClonerAttachmentStatus::Updated;
	...
	void Reset()
	{
		...
		Status = EAvaClonerAttachmentStatus::Updated;
	}
};

struct FAvaClonerEffectorChannelData
{
...
USTRUCT()
struct FAvaClonerEffectorDataInterfaces
{
	...
	explicit FAvaClonerEffectorDataInterfaces(const UNiagaraSystem* InSystem);
	FAvaClonerEffectorDataInterfaces() = default;

	void CopyTo(FAvaClonerEffectorDataInterfaces& InOther) const;
...
struct AVALANCHEEFFECTORS_API FAvaClonerSampleMeshOptions
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct AVALANCHEEFFECTORS_API FAvaClonerSampleSplineOptions
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct AVALANCHEEFFECTORS_API FAvaClonerGridConstraintSphere
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct AVALANCHEEFFECTORS_API FAvaClonerGridConstraintCylinder
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct AVALANCHEEFFECTORS_API FAvaClonerGridConstraintTexture
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, EditInstanceOnly, Category="Cloner")
	EAvaClonerTextureSampleChannel Channel = EAvaClonerTextureSampleChannel::RGBLuminance;

	UPROPERTY(BlueprintReadWrite, EditInstanceOnly, Category="Cloner")
	EAvaClonerPlane Plane = EAvaClonerPlane::XY;

	UPROPERTY(BlueprintReadWrite, EditInstanceOnly, Category="Cloner")
	EAvaClonerCompareMode CompareMode = EAvaClonerCompareMode::Greater;
...
USTRUCT(BlueprintType)
struct AVALANCHEEFFECTORS_API FAvaClonerGridLayoutOptions
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, EditInstanceOnly, Category="Cloner", meta=(EditCondition="Constraint != EAvaClonerGridConstraint::None", EditConditionHides))
	bool bInvertConstraint = false;

	UPROPERTY(BlueprintReadWrite, EditInstanceOnly, Category="Cloner", meta=(EditCondition="Constraint == EAvaClonerGridConstraint::Sphere", EditConditionHides))
	FAvaClonerGridConstraintSphere SphereConstraint;

	UPROPERTY(BlueprintReadWrite, EditInstanceOnly, Category="Cloner", meta=(EditCondition="Constraint == EAvaClonerGridConstraint::Cylinder", EditConditionHides))
	FAvaClonerGridConstraintCylinder CylinderConstraint;

	UPROPERTY(BlueprintReadWrite, EditInstanceOnly, Category="Cloner", meta=(EditCondition="Constraint == EAvaClonerGridConstraint::Texture", EditConditionHides))
	FAvaClonerGridConstraintTexture TextureConstraint;
};

USTRUCT(BlueprintType)
struct AVALANCHEEFFECTORS_API FAvaClonerLineLayoutOptions
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, EditInstanceOnly, Category="Cloner", meta=(ClampMin="0", ClampMax="1", EditCondition="Axis == EAvaClonerAxis::Custom", EditConditionHides))
...
USTRUCT(BlueprintType)
struct AVALANCHEEFFECTORS_API FAvaClonerCircleLayoutOptions
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, EditInstanceOnly, Category="Cloner", meta=(EditCondition="Plane == EAvaClonerPlane::Custom", EditConditionHides))
...
USTRUCT(BlueprintType)
struct AVALANCHEEFFECTORS_API FAvaClonerCylinderLayoutOptions
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct AVALANCHEEFFECTORS_API FAvaClonerSphereLayoutOptions
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct AVALANCHEEFFECTORS_API FAvaClonerHoneycombLayoutOptions
{
	GENERATED_BODY()
