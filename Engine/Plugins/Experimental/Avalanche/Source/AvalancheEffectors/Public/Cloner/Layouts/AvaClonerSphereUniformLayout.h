...
#include "AvaClonerSphereUniformLayout.generated.h"

UCLASS(BlueprintType)
class AVALANCHEEFFECTORS_API UAvaClonerSphereUniformLayout : public UAvaClonerLayoutBase
{
	GENERATED_BODY()
...
public:
	UAvaClonerSphereUniformLayout()
		: UAvaClonerLayoutBase(
			TEXT("SphereUniform")
			, TEXT("/Script/Niagara.NiagaraSystem'/Avalanche/ClonerResources/Systems/NS_ClonerSphere.NS_ClonerSphere'")
		)
	{}
...
#if WITH_EDITOR
	/** Used for PECP */
	static const TAvaPropertyChangeDispatcher<UAvaClonerSphereUniformLayout> PropertyChangeDispatcher;
#endif
};