...
#include "AvaClonerSphereRandomLayout.generated.h"

UCLASS(BlueprintType)
class AVALANCHEEFFECTORS_API UAvaClonerSphereRandomLayout : public UAvaClonerLayoutBase
{
	GENERATED_BODY()
...
public:
	UAvaClonerSphereRandomLayout()
		: UAvaClonerLayoutBase(
			TEXT("SphereRandom")
			, TEXT("/Script/Niagara.NiagaraSystem'/Avalanche/ClonerResources/Systems/NS_ClonerSphereRandom.NS_ClonerSphereRandom'")
		)
	{}
...
#if WITH_EDITOR
	/** Used for PECP */
	static const TAvaPropertyChangeDispatcher<UAvaClonerSphereRandomLayout> PropertyChangeDispatcher;
#endif
};