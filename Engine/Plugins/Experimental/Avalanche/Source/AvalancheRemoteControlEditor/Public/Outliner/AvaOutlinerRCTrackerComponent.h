 ...
 */
class AVALANCHEREMOTECONTROLEDITOR_API FAvaOutlinerRCTrackerComponent : public FAvaOutlinerObject
{
public:
...
protected:
	...
	static FOnAvaOutlinerRCTrackerComponentSelected OnRCTrackerSelectedDelegate;
