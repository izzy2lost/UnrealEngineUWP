...
/**
 * Delegates related to IAvaMediaPlaybackClient.
 * 
 ...
 * the delegates outside of IAvaMediaPlaybackClient's implementation simplify the delegate handler
 * management.
 */
namespace UE::AvaMediaPlaybackClient::Delegates
{
	struct FPlaybackStatusChangedArgs
	{
		...
		EAvaMediaPlaybackStatus PrevStatus;
		EAvaMediaPlaybackStatus NewStatus;
	};
	...
	struct FPlaybackAssetStatusChangedArgs
	{
		const FSoftObjectPath& AssetPath;
		const FString& ServerName;
		EAvaMediaPlaybackAssetStatus Status;
	};
	...
	struct FPlaybackSequenceEventArgs
	{
		...
		EAvalanchePlayableSequenceEventType EventType;
	};
	...
	struct FPlaybackTransitionEventArgs
	{
		...
		const FString& ChannelName;
		const FString& ServerName;
		EAvalanchePlayableTransitionEventFlags EventFlags;
	};
	 ...
	 */
	DECLARE_MULTICAST_DELEGATE_TwoParams(FOnConnectionEvent, IAvaMediaPlaybackClient&, const FConnectionEventArgs&);
	...
	*/
	DECLARE_MULTICAST_DELEGATE_TwoParams(FOnPlaybackStatusChanged, IAvaMediaPlaybackClient&, const FPlaybackStatusChangedArgs&);
	...
	*/
	DECLARE_MULTICAST_DELEGATE_TwoParams(FOnPlaybackAssetStatusChanged, IAvaMediaPlaybackClient&, const FPlaybackAssetStatusChangedArgs&);
	AVALANCHEMEDIA_API FOnPlaybackAssetStatusChanged& GetOnPlaybackAssetStatusChanged();

	/**
	* Delegate called when a playback status changed message is received.
	*/
	DECLARE_MULTICAST_DELEGATE_TwoParams(FOnPlaybackSequenceEvent, IAvaMediaPlaybackClient&, const FPlaybackSequenceEventArgs&);
	AVALANCHEMEDIA_API FOnPlaybackSequenceEvent& GetOnPlaybackSequenceEvent();

	/**
	* Delegate called when a playback status changed message is received.
	*/
	DECLARE_MULTICAST_DELEGATE_TwoParams(FOnPlaybackTransitionEvent, IAvaMediaPlaybackClient&, const FPlaybackTransitionEventArgs&);
