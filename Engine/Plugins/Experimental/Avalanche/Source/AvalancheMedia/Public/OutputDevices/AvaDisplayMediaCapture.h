...
#include "AvaDisplayMediaCapture.generated.h"

DECLARE_LOG_CATEGORY_EXTERN(LogAvaDisplayMedia, Log, All);

UCLASS()
class AVALANCHEMEDIA_API UAvaDisplayMediaCapture : public UMediaCapture
{
	GENERATED_BODY()

public:
	virtual ~UAvaDisplayMediaCapture();	// so we can pimpl.
