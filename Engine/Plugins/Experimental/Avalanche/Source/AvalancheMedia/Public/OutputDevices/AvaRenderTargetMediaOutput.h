...
#include "AvaRenderTargetMediaOutput.generated.h"
 ...
 */
UCLASS(BlueprintType, meta = (MediaIOCustomLayout = "AvaRenderTarget"))
class AVALANCHEMEDIA_API UAvaRenderTargetMediaOutput : public UMediaOutput
{
	GENERATED_BODY()
