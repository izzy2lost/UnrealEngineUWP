...
namespace UE::AvaMediaOutputUtils
{
	...
	/** Serializes the given MediaOutput object into a FAvaMediaOutputData. */ 
	AVALANCHEMEDIA_API FAvaMediaOutputData CreateMediaOutputData(UMediaOutput* InMediaOutput);

	/** Create a MediaOutput object from the given data. */
	AVALANCHEMEDIA_API UMediaOutput* CreateMediaOutput(const FAvaMediaOutputData& InMediaOutputData, UObject* InOuter);
}
