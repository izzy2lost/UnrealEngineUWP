...
#include "AvaSyncProviderFeatureTypes.generated.h"

UENUM()
enum class EAvaSyncResponseResult : uint8
{
...
UENUM()
enum class EAvaSyncEngineType : uint8
{
	Server,
	Commandlet,
	Editor,
...
USTRUCT()
struct AVALANCHEMEDIA_API FAvaSyncConnectionInfo
{
	GENERATED_BODY()
	...
	EAvaSyncEngineType InstanceType = EAvaSyncEngineType::Unknown;
...
USTRUCT()
struct AVALANCHEMEDIA_API FAvaSyncResponse
{
	GENERATED_BODY()

	/** Status of the response, error or success */
	EAvaSyncResponseResult Status = EAvaSyncResponseResult::Unknown;
...
USTRUCT()
struct AVALANCHEMEDIA_API FAvaSyncCompareResponse : public FAvaSyncResponse
{
	GENERATED_BODY()
	...
	/** Default constructor */
	FAvaSyncCompareResponse() = default;
