...
namespace UE::AvaSerializationUtils::Private
{
...
void UE::AvaSerializationUtils::SerializeObject(FStructuredArchiveFormatter& InFormatter, UObject* InObject, const TFunction<bool(FProperty*)>& InShouldSkipProperty)
{
...
void UE::AvaSerializationUtils::JsonValueConversion::BytesToString(const TArray<uint8>& InValueAsBytes, FString& OutValueAsString)
{
