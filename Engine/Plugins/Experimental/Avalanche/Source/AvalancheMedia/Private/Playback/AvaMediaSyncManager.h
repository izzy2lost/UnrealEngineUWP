 ...
 */
class FAvaMediaSyncManager : public TSharedFromThis<FAvaMediaSyncManager>
{
public:
	FAvaMediaSyncManager(const FString& InRemoteName);
	~FAvaMediaSyncManager();
	 ...
	 */
	DECLARE_MULTICAST_DELEGATE_OneParam(FOnAvaAssetSyncStatusReceived, const FAvaAssetSyncStatusReceivedParams&);
