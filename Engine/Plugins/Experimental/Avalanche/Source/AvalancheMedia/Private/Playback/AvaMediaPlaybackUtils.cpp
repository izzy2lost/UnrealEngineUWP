...
void FAvaMediaPlaybackUtils::FlushPackageLoading(UPackage* InPackage)
{
...
bool FAvaMediaPlaybackUtils::IsPackageDeleted(const UPackage* InExistingPackage)
{
...
namespace UE::AvaMediaPlaybackUtils::Private
{
#if WITH_EDITOR
...
void FAvaMediaPlaybackUtils::PurgePackages(const TArray<UPackage*>& InExistingPackages)
{
#if WITH_EDITOR
	using namespace UE::AvaMediaPlaybackUtils::Private;
...
bool FAvaMediaPlaybackUtils::ReloadPackages(const TArray<UPackage*>& InExistingPackages)
{
	FlushAsyncLoading();
	{
		bool bRunGC = false;
...
bool FAvaMediaPlaybackUtils::IsMapAsset(const FString& InPackageName)
{
	FString FullPath;
...
bool FAvaMediaPlaybackUtils::IsPlayableAsset(const FAssetData& InAssetData)
{
	...
	{
		const FAssetTagValueRef AvalancheSceneTag = InAssetData.TagsAndValues.FindTag(UE::Ava::AssetTags::AvalancheScene);
		if (!AvalancheSceneTag.IsSet() || !AvalancheSceneTag.Equals(UE::Ava::AssetTags::Values::Enabled))
		{
			return false;
		}
	}
...
namespace UE::AvaMediaPlayback::Utils
{
