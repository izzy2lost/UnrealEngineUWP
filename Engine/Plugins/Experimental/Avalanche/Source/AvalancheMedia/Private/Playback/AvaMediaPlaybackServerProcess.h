...
public:
	 ...
	 */
	static TSharedPtr<FAvaMediaPlaybackServerProcess> Find(const FAvaMediaPlaybackClient& InPlaybackClient);
	 ...
	 */
	static TSharedPtr<FAvaMediaPlaybackServerProcess> FindOrCreate(const FAvaMediaPlaybackClient& InPlaybackClient);
