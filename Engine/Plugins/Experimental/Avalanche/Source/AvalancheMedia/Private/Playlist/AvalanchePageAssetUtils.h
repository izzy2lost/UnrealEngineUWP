...
/**
 * Common utility functions to query information about loaded Avalanche assets.
 ...
 * For "runtime" (fully initialized) instances, UAvalanchePlayable should be used instead.
 */ 
class FAvalanchePageAssetUtils
{
public:
