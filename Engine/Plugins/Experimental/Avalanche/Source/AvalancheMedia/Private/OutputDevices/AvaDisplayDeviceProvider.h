...
//#include "AvaDisplayDeviceProvider.generated.h"

/**
 * Implementation of IMediaIOCoreDeviceProvider for UAvaDisplayMediaOutput.
 */
class FAvaDisplayDeviceProvider : public IMediaIOCoreDeviceProvider
{
public:
