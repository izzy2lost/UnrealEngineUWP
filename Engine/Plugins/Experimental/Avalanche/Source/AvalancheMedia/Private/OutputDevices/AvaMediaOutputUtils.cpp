...
namespace UE::AvaMediaOutputUtils::Private
{
...
FString UE::AvaMediaOutputUtils::GetDeviceName(const UMediaOutput* InMediaOutput)
{
...
bool UE::AvaMediaOutputUtils::HasDeviceProviderName(const UClass* InMediaOutputClass)
{
...
FName UE::AvaMediaOutputUtils::GetDeviceProviderName(const UClass* InMediaOutputClass)
{
#if WITH_EDITORONLY_DATA
...
FName UE::AvaMediaOutputUtils::GetDeviceProviderName(const UMediaOutput* InMediaOutput)
{
#if WITH_EDITORONLY_DATA
...
FAvaMediaOutputData UE::AvaMediaOutputUtils::CreateMediaOutputData(UMediaOutput* InMediaOutput)
{
	FAvaMediaOutputData MediaOutputData;
...
UMediaOutput* UE::AvaMediaOutputUtils::CreateMediaOutput(const FAvaMediaOutputData& InMediaOutputData, UObject* InOuter)
{
