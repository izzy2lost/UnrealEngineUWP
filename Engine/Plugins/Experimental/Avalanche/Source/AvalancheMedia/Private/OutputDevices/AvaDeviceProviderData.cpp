...
void FAvaDeviceProviderData::PopulateFrom(const FName& InName, const IMediaIOCoreDeviceProvider* InDeviceProvider)
{
	Name = InName;
...
void FAvaDeviceProviderData::ApplyServerName(const FString& InServerName)
{
...
bool FAvaDeviceProviderDataList::SaveToJson()
{
...
bool FAvaDeviceProviderDataList::SaveToXml()
{
	TUniquePtr<FArchive> FileWriter(
...
bool FAvaDeviceProviderDataList::LoadFromJson()
{
...
void FAvaDeviceProviderDataList::Populate(const FString& InAssignedServerName)
{
	...
	{
		FAvaDeviceProviderData DeviceProviderData;
