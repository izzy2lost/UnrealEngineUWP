...
namespace AvaDXGIHelper
{
	...
	static void EnumMonitorsWindowsDXGI(TArray<FAvaMonitorInfo>& OutMonitorInfo)
	{
...
static void EnumMonitorsGeneric(TArray<FAvaMonitorInfo>& OutMonitorInfo)
{
...
void FAvaDisplayDeviceManager::EnumMonitors(TArray<FAvaMonitorInfo>& OutMonitorInfo)
{
#if PLATFORM_WINDOWS
...
TArray<FAvaMonitorInfo> FAvaDisplayDeviceManager::CachedMonitorInfo;

const TArray<FAvaMonitorInfo>&  FAvaDisplayDeviceManager::GetCachedMonitors(bool bInForceUpdate)
{
...
FString FAvaDisplayDeviceManager::GetMonitorDisplayName(const FAvaMonitorInfo& InMonitorInfo)
{
