...
void UE::AvaRenderTargetMediaUtils::ClearRenderTarget(UTextureRenderTarget2D* InRenderTarget)
{
...
void UE::AvaRenderTargetMediaUtils::CopyTexture(FRHICommandListImmediate& InRHICmdList, FTextureRHIRef InSourceTexture, FTextureRHIRef InDestTarget)
{
...
namespace UE::AvaRenderTargetMediaUtils::Private
{
