...
#include "SAvaPlaybackGraphNode_Player.h"
 ...
 */
struct SAvaPlaybackGraphNode_Player::FPreviewBrush
{
...
SAvaPlaybackGraphNode_Player::SAvaPlaybackGraphNode_Player() = default;
SAvaPlaybackGraphNode_Player::~SAvaPlaybackGraphNode_Player() = default;

void SAvaPlaybackGraphNode_Player::PostConstruct()
{
	...
	{
		RenderTargetSize = FAvaOutputChannel::GetDefaultMediaOutputSize(EAvaBroadcastChannelType::Program);
	}	
	PlayerPreviewBrush = MakeUnique<FPreviewBrush>(FVector2d(RenderTargetSize.X, RenderTargetSize.Y));
}

TSharedRef<SWidget> SAvaPlaybackGraphNode_Player::CreatePreviewWidget()
{
	return SNew(SBox)
		.WidthOverride(106.f)
			...
			[
				...
				[
					...
					.ImageArgs(SImage::FArguments()
						.Image(this, &SAvaPlaybackGraphNode_Player::GetPlayerPreviewBrush))
...
const FSlateBrush* SAvaPlaybackGraphNode_Player::GetPlayerPreviewBrush() const
{
...
void SAvaPlaybackGraphNode_Player::CreateBelowPinControls(TSharedPtr<SVerticalBox> MainBox)
{
...
TSharedRef<SWidget> SAvaPlaybackGraphNode_Player::CreateNodeContentArea()
{
	// NODE CONTENT AREA
	return SNew(SBorder)
		.BorderImage(FAppStyle::GetBrush("NoBorder"))
