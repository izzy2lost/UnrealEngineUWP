...
#include "MediaOutputEditorUtils.h"
#include "Dom/JsonObject.h"
#include "Serialization/JsonReader.h"
#include "Serialization/JsonSerializer.h"
#include "Serialization/JsonWriter.h"

DEFINE_LOG_CATEGORY(LogMediaOutputEditorUtils);

FAvaMediaOutputEditorUtils::FAvaMediaOutputEditorUtils()
{
}
...
FString FAvaMediaOutputEditorUtils::SerializeMediaOutput(const UMediaOutput* InMediaOutput)
{
...
void FAvaMediaOutputEditorUtils::EditMediaOutput(UMediaOutput* InMediaOutput, const FString& InDeviceData)
{
...
TSharedPtr<FJsonObject> FAvaMediaOutputEditorUtils::ParsePropertyInfo(TFieldIterator<FProperty> InProperty,
...
TSharedPtr<FJsonObject> FAvaMediaOutputEditorUtils::ParseElementaryPropertyInfo(
	TFieldIterator<FProperty> InProperty, const void* InOwnerObject)
{
	...
	{
		UE_LOG(LogMediaOutputEditorUtils, Warning, TEXT("Property type: %s is not supported"), *InProperty->GetClass()->GetName());
	}

	return PropertyObject;
}

TSharedPtr<FJsonObject> FAvaMediaOutputEditorUtils::ParseEnumPropertyInfo(
	TFieldIterator<FProperty> InProperty, const void* InOwnerObject)
{
	const TSharedPtr<FJsonObject> PropertyObject = MakeShareable(new FJsonObject);
...
TSharedPtr<FJsonObject> FAvaMediaOutputEditorUtils::ParseStructPropertyInfo(
	TFieldIterator<FProperty> InProperty, const void* InOwnerObject)
{
	const TSharedPtr<FJsonObject> PropertyObject = MakeShareable(new FJsonObject);
...
void FAvaMediaOutputEditorUtils::SetProperty(void* InOwnerObject, const TSharedPtr<FJsonObject>& InPropertyObject,
...
void FAvaMediaOutputEditorUtils::SetElementaryProperty(void* InOwnerObject,
...
void FAvaMediaOutputEditorUtils::SetEnumProperty(void* InOwnerObject,
	const TSharedPtr<FJsonObject>& InPropertyObject, TFieldIterator<FProperty> InProperty)
{
...
void FAvaMediaOutputEditorUtils::SetStructProperties(void* InOwnerObject,
	const TSharedPtr<FJsonObject>& InPropertyObject, TFieldIterator<FProperty> InProperty)
{
