...
#define LOCTEXT_NAMESPACE "AvaPageWidgetUtils"

BEGIN_SLATE_FUNCTION_BUILD_OPTIMIZATION

TSharedRef<SWidget> FAvaPageWidgetUtils::CreateNodeValueWidget(const TSharedPtr<IDetailTreeNode>& InNode)
{
...
bool FAvaPageWidgetUtils::FindPropertyHandleRecursive(const TSharedPtr<IPropertyHandle>& InPropertyHandle, const FString& InPropertyNameOrPath, EFindNodeMethod InFindMethod)
{
...
TSharedPtr<IDetailTreeNode> FAvaPageWidgetUtils::FindTreeNodeRecursive(const TSharedRef<IDetailTreeNode>& InRootNode, const FString& InPropertyNameOrPath, EFindNodeMethod InFindMethod)
{
...
TSharedPtr<IDetailTreeNode> FAvaPageWidgetUtils::FindNode(const TArray<TSharedRef<IDetailTreeNode>>& InRootNodes, const FString& InQualifiedPropertyName, EFindNodeMethod InFindMethod)
{
