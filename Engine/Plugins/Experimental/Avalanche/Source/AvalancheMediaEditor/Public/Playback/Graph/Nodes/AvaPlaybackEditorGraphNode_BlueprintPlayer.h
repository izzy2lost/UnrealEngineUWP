...
#include "AvaPlaybackEditorGraphNode_BlueprintPlayer.generated.h"

UCLASS()
class AVALANCHEMEDIAEDITOR_API UAvaPlaybackEditorGraphNode_BlueprintPlayer : public UAvaPlaybackEditorGraphNode
{
	GENERATED_BODY()
