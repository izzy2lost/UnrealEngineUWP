...
DECLARE_DELEGATE_RetVal_OneParam(bool, FAvaEaseCurvePresetDelegate, const TSharedPtr<FAvaEaseCurvePreset>&)
...
public:
	...
	{}
		...
		SLATE_EVENT(FAvaEaseCurvePresetDelegate, OnClick)
...
protected:
	...
	FAvaEaseCurvePresetDelegate OnClick;
