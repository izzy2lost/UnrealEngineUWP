...
class AVALANCHESHAPES_API UAvaShape2DArrowDynamicMesh : public UAvaShape2DDynMeshBase
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(EditInstanceOnly, BlueprintReadWrite, Category="Shape", meta=(ClampMin="0.0", ClampMax="1.0", DisplayName="Ratio Arrow Line", AllowPrivateAccess="true"))
	float RatioArrowLine;

	// represents the ratio for the line height, 1 means 100% of the height available
	UPROPERTY(EditInstanceOnly, BlueprintReadWrite, Category="Shape", meta=(ClampMin="0.0", ClampMax="1.0", DisplayName="Ratio Line Height", AllowPrivateAccess="true"))
	...
	UPROPERTY(EditInstanceOnly, BlueprintReadWrite, Category="Shape", meta=(ClampMin="0.0", ClampMax="1.0", DisplayName="Ratio Arrow Y", AllowPrivateAccess="true"))
	float RatioArrowY;

	// represents the ratio for the arrow end, 0 means arrow point will be at bottom, 1 means arrow point will be at top
	UPROPERTY(EditInstanceOnly, BlueprintReadWrite, Category="Shape", meta=(ClampMin="0.0", ClampMax="1.0", DisplayName="Ratio Line Y", AllowPrivateAccess="true"))
	float RatioLineY;

	// whether there should be an arrow on both side, arrows will have same ratio
	UPROPERTY(EditInstanceOnly, BlueprintReadWrite, Category="Shape", meta=(DisplayName="Both Side Arrows", AllowPrivateAccess="true"))
