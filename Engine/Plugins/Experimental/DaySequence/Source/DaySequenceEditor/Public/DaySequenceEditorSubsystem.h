...
#include "LevelSequenceEditorSubsystem.h" // For FMovieSceneScriptingParams

#include "DaySequenceEditorSubsystem.generated.h"

DECLARE_LOG_CATEGORY_EXTERN(LogDaySequenceEditor, Log, All);
...
/**
* UDaySequenceEditorSubsystem
* Subsystem for day sequence editor related utilities to scripts
*/
UCLASS()
class DAYSEQUENCEEDITOR_API UDaySequenceEditorSubsystem : public UEditorSubsystem
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Day Sequence Editor")
