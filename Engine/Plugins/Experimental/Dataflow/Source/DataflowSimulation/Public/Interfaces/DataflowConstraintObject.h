 ...
 */
USTRUCT()
struct DATAFLOWSIMULATION_API FDataflowConstraintObjectProxy : public FDataflowPhysicsObjectProxy
{
	GENERATED_BODY()
...
UINTERFACE()
class DATAFLOWSIMULATION_API UDataflowConstraintObjectInterface : public UDataflowPhysicsObjectInterface
{
	GENERATED_BODY()
};
 ...
 */
class DATAFLOWSIMULATION_API IDataflowConstraintObjectInterface : public IDataflowPhysicsObjectInterface
{
	GENERATED_BODY()
