...
UCustomizableObject* UCustomizableObjectEditorFunctionLibrary::NewCustomizableObject(const FNewCustomizableObjectParameters& Parameters)
{
	...
	Factory->CreationSettings.bEmptyObject = false;
	Factory->CreationSettings.bIsChildObject = Parameters.ParentObject != nullptr;
	Factory->CreationSettings.ParentObject = Parameters.ParentObject;
	Factory->CreationSettings.GroupNodeName = Parameters.ParentGroupNode;
