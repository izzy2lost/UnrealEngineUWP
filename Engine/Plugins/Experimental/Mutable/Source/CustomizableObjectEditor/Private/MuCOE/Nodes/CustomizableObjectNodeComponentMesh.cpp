...
const FName UCustomizableObjectNodeComponentMesh::OutputPinName(TEXT("Component"));
...
FLinearColor UCustomizableObjectNodeComponentMesh::GetNodeTitleColor() const
{
	const UEdGraphSchema_CustomizableObject* Schema = GetDefault<UEdGraphSchema_CustomizableObject>();
...
void UCustomizableObjectNodeComponentMesh::GetPinSection(const UEdGraphPin& Pin, int32& OutLODIndex, int32& OutSectionIndex) const
{
...
UMaterialInterface* UCustomizableObjectNodeComponentMesh::GetMaterialFor(const UEdGraphPin* Pin) const
{
	USkeletalMesh* SkeletalMesh = Cast<USkeletalMesh>(Mesh.TryLoad());
	if (SkeletalMesh)
	{
...
FSkeletalMaterial* UCustomizableObjectNodeComponentMesh::GetSkeletalMaterialFor(const UEdGraphPin& Pin) const
{
	int32 LODIndex;
	int32 SectionIndex;
...
FText UCustomizableObjectNodeComponentMesh::GetTooltipText() const
{
	return LOCTEXT("Component_Mesh_Tooltip", "Define a new object component based on a Skeletal Mesh.");
}


UMaterialInterface* UCustomizableObjectNodeComponentMesh::GetMaterialInterfaceFor(const int32 LODIndex, const int32 SectionIndex, const FSkeletalMeshModel* ImportedModel) const
{
...
FSkeletalMaterial* UCustomizableObjectNodeComponentMesh::GetSkeletalMaterialFor(const int32 LODIndex, const int32 SectionIndex, const FSkeletalMeshModel* ImportedModel) const
{
	USkeletalMesh* SkeletalMesh = Cast<USkeletalMesh>(Mesh.TryLoad());
	if (!SkeletalMesh)
	{
...
UEdGraphPin* UCustomizableObjectNodeComponentMesh::GetMaterialPin(const int32 LODIndex, const int32 SectionIndex) const
{
