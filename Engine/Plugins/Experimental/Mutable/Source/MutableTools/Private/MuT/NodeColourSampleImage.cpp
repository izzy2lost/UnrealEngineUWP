...
namespace mu
{
	...
	//---------------------------------------------------------------------------------------------
	FNodeType NodeColourSampleImage::Private::s_type = FNodeType (Node::EType::ColorSampleImage, NodeColour::GetStaticType() );
	...
	MUTABLE_IMPLEMENT_NODE( NodeColourSampleImage )
