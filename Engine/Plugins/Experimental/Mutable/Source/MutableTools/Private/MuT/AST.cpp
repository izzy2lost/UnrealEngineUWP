...
void ASTOp::GetBlockLayoutSizeCached(uint64 blockIndex, int32* BlockX, int32* BlockY, FBlockLayoutSizeCache* cache)
{
    ...
    GetBlockLayoutSize( blockIndex, BlockX, BlockY, cache );
