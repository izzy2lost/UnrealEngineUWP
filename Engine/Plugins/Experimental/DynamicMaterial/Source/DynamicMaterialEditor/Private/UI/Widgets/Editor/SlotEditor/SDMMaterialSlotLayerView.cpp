...
SDMMaterialSlotLayerView::FOnSelectionChanged::RegistrationType& SDMMaterialSlotLayerView::GetOnSelectionChanged()
{
...
{
	OnSelectionChanged.Broadcast(SharedThis(this), InSelectedItem);
}
