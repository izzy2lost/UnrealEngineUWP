...
public:
	...
	*/
	...
	virtual bool InputAxis(FViewport* InViewport, FInputDeviceId InDeviceId, FKey InKey, float InDelta, float InDeltaTime,
		int32 InNumSamples /* =1 */, bool bGamepad /* =false */) override;
