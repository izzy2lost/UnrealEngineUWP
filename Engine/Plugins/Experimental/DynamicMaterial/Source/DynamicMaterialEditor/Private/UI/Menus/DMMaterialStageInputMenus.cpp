...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_PreviousStage_Outputs_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_PreviousStage_Output_Channels_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel, 
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_PreviousStage_Output_Channel_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel, 
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_PreviousStage_Output_Channel_Channels_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel, 
	EDMMaterialPropertyType InSlotProperty, int32 InOutputIndex)
{
	InChildMenuBuilder.AddSubMenu(
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_PreviousStage_Output_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel,
	EDMMaterialPropertyType InSlotProperty, int32 InOutputIndex, bool bInAcceptsWholeChannel, bool bInAcceptsSubChannels)
{
	...
	if (bInAcceptsSubChannels)
	{
		...
		{
			FDMMaterialStageInputMenus::GenerateChangeInputMenu_PreviousStage_Output_Channel_Channels_Impl(InChildMenuBuilder, InMenuName, InStage, InThroughput,
				InInputIndex, InInputChannel, InSlotProperty, InOutputIndex);
		}
		else
		{
			FDMMaterialStageInputMenus::GenerateChangeInputMenu_PreviousStage_Output_Channels_Impl(InChildMenuBuilder, InMenuName, InStage, InThroughput,
				InInputIndex, InInputChannel, InSlotProperty, InOutputIndex);
		}
	}
	else
	{
		FDMMaterialStageInputMenus::GenerateChangeInputMenu_PreviousStage_Output_Channel_Impl(InChildMenuBuilder, InMenuName, InStage, InThroughput,
	...
	const int32 InInputIndex, const int32 InInputChannel)
{
	...
	for (EDMMaterialPropertyType SlotProperty : SlotProperties)
	{
		...
		if (bJustOneConnector)
		{
			...
			FDMMaterialStageInputMenus::GenerateChangeInputMenu_PreviousStage_Output_Impl(
				InChildMenuBuilder,
				PropertyAndChannel, 
				Stage, 
				InThroughput, 
		...
		{
			FDMMaterialStageInputMenus::GenerateChangeInputMenu_PreviousStage_Outputs_Impl(InChildMenuBuilder, PropertyObj->GetDescription(), 
	...
	const int32 InInputIndex, const int32 InInputChannel, EDMMaterialPropertyType InMaterialProperty, const int32 OutputIndex)
{
	...
	InChildMenuBuilder.BeginSection("ChangeInputOutputChannels", LOCTEXT("ChangeInputOutputChannels", "Output Channels"));
	{
		for (int32 ChannelIndex = 0; ChannelIndex < FloatSize; ++ChannelIndex)
		{
			...
			FDMMaterialStageInputMenus::GenerateChangeInputMenu_PreviousStage_Output_Channel_Impl(
				InChildMenuBuilder, 
				ChannelName, 
				Stage, 
				InThroughput,
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_GlobalValue_Channels_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel,
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_GlobalValue_Channel_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel,
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_GlobalValue_Value_Channels_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel,
	int32 InValueIndex, UDMMaterialValue* InValue)
{
	InChildMenuBuilder.AddSubMenu(
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_GlobalValue_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel,
	int32 InValueIndex, UDMMaterialValue* InValue, bool bInAcceptsWholeChannel, bool bInAcceptsSubChannels)
{
	...
	if (bInAcceptsSubChannels)
	{
		if (bInAcceptsWholeChannel)
		{
			FDMMaterialStageInputMenus::GenerateChangeInputMenu_GlobalValue_Value_Channels_Impl(
				InChildMenuBuilder, 
				InMenuName, 
				InStage, 
				InThroughput,
		...
		{
			FDMMaterialStageInputMenus::GenerateChangeInputMenu_GlobalValue_Channels_Impl(
				InChildMenuBuilder, 
				InMenuName, 
				InStage, 
				InThroughput,
	...
	{
		FDMMaterialStageInputMenus::GenerateChangeInputMenu_GlobalValue_Channel_Impl(
			InChildMenuBuilder, 
			InMenuName, 
			InStage, 
			InThroughput,
	...
	const int32 InInputIndex, const int32 InInputChannel)
{
	...
	for (int32 Index = 0; Index < Values.Num(); ++Index)
	{
		...
		FDMMaterialStageInputMenus::GenerateChangeInputMenu_GlobalValue_Impl(
			InChildMenuBuilder,
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_Slot_Properties_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel,
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_Slot_Property_Outputs_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel, 
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_Slot_Property_Output_Channels_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel, 
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_Slot_Property_Output_Channel_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel, 
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_Slot_Property_Output_Channel_Channels_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel, 
	UDMMaterialSlot* InSlot, EDMMaterialPropertyType InSlotProperty, int32 InOutputIndex)
{
	InChildMenuBuilder.AddSubMenu(
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_Slot_Property_Output_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel, 
	...
	bool bInAcceptsSubChannels)
{
	...
	if (bInAcceptsSubChannels)
	{
		if (bInAcceptsWholeChannel)
		{
			FDMMaterialStageInputMenus::GenerateChangeInputMenu_Slot_Property_Output_Channel_Channels_Impl(
				InChildMenuBuilder, 
				InMenuName, 
				InStage, 
				InThroughput,
		...
		{
			FDMMaterialStageInputMenus::GenerateChangeInputMenu_Slot_Property_Output_Channels_Impl(
				InChildMenuBuilder, 
				InMenuName, 
				InStage, 
				InThroughput,
	...
	{
		FDMMaterialStageInputMenus::GenerateChangeInputMenu_Slot_Property_Output_Channel_Impl(
			InChildMenuBuilder, 
			InMenuName, 
			InStage, 
			InThroughput,
	...
	const int32 InInputIndex, const int32 InInputChannel)
{
	...
	for (UDMMaterialSlot* SlotIter : Slots)
	{
		...
		if (bOneSlotProperty)
		{
			...
			if (bOneOutputType)
			{
				UDMMaterialLayerObject* PropertyLayer = SlotIter->GetLastLayerForMaterialProperty(SlotProperties[0]);
				...
				FDMMaterialStageInputMenus::GenerateChangeInputMenu_Slot_Property_Output_Impl(
					InChildMenuBuilder, 
					SlotPropertyName,
					Stage,
					InThroughput, 
			...
			{
				FDMMaterialStageInputMenus::GenerateChangeInputMenu_Slot_Property_Outputs_Impl(
					InChildMenuBuilder, 
					SlotPropertyName,
					Stage, 
					InThroughput, 
		...
		{
			FDMMaterialStageInputMenus::GenerateChangeInputMenu_Slot_Properties_Impl(
				InChildMenuBuilder, 
	...
	const int32 InInputIndex, const int32 InInputChannel, UDMMaterialSlot* InSlot)
{
	...
	InChildMenuBuilder.BeginSection("ChangeInputMaterialProperties", LOCTEXT("ChangeInputMaterialProperties", "Material Properties"));
	{
		for (EDMMaterialPropertyType SlotProperty : ModelEditorOnlyData->GetMaterialPropertiesForSlot(InSlot))
		{
			...
			if (bOneOutputType)
			{
				UDMMaterialLayerObject* PropertyLayer = InSlot->GetLastLayerForMaterialProperty(SlotProperty);
	...
	const int32 InInputIndex, const int32 InInputChannel, UDMMaterialSlot* InSlot, EDMMaterialPropertyType InMaterialProperty)
{
	...
	InChildMenuBuilder.BeginSection("ChangeInputOutputs", LOCTEXT("ChangeInputOutputs", "Outputs"));
	{
		...
		{
			UDMMaterialLayerObject* PropertyLayer = InSlot->GetLastLayerForMaterialProperty(InMaterialProperty);
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_Expression_Outputs_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel, 
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_Expression_Output_Channels_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel, 
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_Expression_Output_Channel_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel, 
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_Expression_Output_Channel_Channels_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel,
	TSubclassOf<UDMMaterialStageExpression> InExpressionClass, int32 InOutputIndex)
{
	InChildMenuBuilder.AddSubMenu(
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_Expression_Output_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel, 
	TSubclassOf<UDMMaterialStageExpression> InExpressionClass, int32 InOutputIndex, bool bInAcceptsWholeChannel, bool bInAcceptsSubChannels)
{
	...
	if (bInAcceptsSubChannels)
	{
		if (bInAcceptsWholeChannel)
		{
			FDMMaterialStageInputMenus::GenerateChangeInputMenu_Expression_Output_Channel_Channels_Impl(
				InChildMenuBuilder, 
				InMenuName, 
				InStage, 
				InThroughput,
		...
		{
			FDMMaterialStageInputMenus::GenerateChangeInputMenu_Expression_Output_Channels_Impl(
				InChildMenuBuilder, 
				InMenuName, 
				InStage, 
				InThroughput,
	...
	{
		FDMMaterialStageInputMenus::GenerateChangeInputMenu_Expression_Output_Channel_Impl(
			InChildMenuBuilder, 
			InMenuName, 
			InStage, 
			InThroughput,
	...
	const int32 InInputIndex, const int32 InInputChannel)
{
	...
	if (ValidOutputConnectorCount == 1)
	{
		...
		FDMMaterialStageInputMenus::GenerateChangeInputMenu_Expression_Output_Impl(
			InChildMenuBuilder, 
			ExpressionName, 
			Stage, 
			InThroughput,
	...
	{
		FDMMaterialStageInputMenus::GenerateChangeInputMenu_Expression_Outputs_Impl(
			InChildMenuBuilder, 
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_UV_Channels_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel)
{
	InChildMenuBuilder.AddSubMenu(
		InMenuName,
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_UV_Channel_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_UV_UV_Channels_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel)
{
	InChildMenuBuilder.AddSubMenu(
		InMenuName,
...
void FDMMaterialStageInputMenus::GenerateChangeInputMenu_UV_Impl(FMenuBuilder& InChildMenuBuilder, const FText& InMenuName,
	UDMMaterialStage* InStage, UDMMaterialStageThroughput* InThroughput, int32 InInputIndex, int32 InInputChannel,
	bool bInAcceptsWholeChannel, bool bInAcceptsSubChannels)
{
	...
	if (bInAcceptsSubChannels)
	{
		if (bInAcceptsWholeChannel)
		{
			FDMMaterialStageInputMenus::GenerateChangeInputMenu_UV_UV_Channels_Impl(
				InChildMenuBuilder, 
				InMenuName, 
				InStage, 
				InThroughput,
		...
		{
			FDMMaterialStageInputMenus::GenerateChangeInputMenu_UV_Channels_Impl(
				InChildMenuBuilder, 
				InMenuName, 
				InStage, 
				InThroughput,
	...
	{
		FDMMaterialStageInputMenus::GenerateChangeInputMenu_UV_Channel_Impl(
			InChildMenuBuilder, 
			InMenuName, 
			InStage, 
			InThroughput,
	...
	const int32 InInputIndex, const int32 InInputChannel)
{
	...
	FDMMaterialStageInputMenus::GenerateChangeInputMenu_UV_Impl(
		InChildMenuBuilder, 
