...
{
	void AddTextureUVDynamicPropertyRow(const TSharedRef<SWidget>& InComponentEditWidget, UDMMaterialComponent* InTextureUVDynamic, 
		FName InProperty, bool bInEnabled, TArray<FDMPropertyHandle>& InOutPropertyRows);

	void AddTextureUVDynamicVisualizerRow(const TSharedRef<SWidget>& InComponentEditWidget, UDMTextureUVDynamic* InTextureUVDynamic, 
...
void FDMTextureUVDynamicPropertyRowGenerator::AddComponentProperties(const TSharedRef<SDMComponentEdit>& InComponentEditWidget, 
	UDMMaterialComponent* InComponent, TArray<FDMPropertyHandle>& InOutPropertyRows, TSet<UDMMaterialComponent*>& InOutProcessedObjects)
{
	...
	AddTextureUVDynamicPropertyRow(InComponentEditWidget, TextureUVDynamic, UDMTextureUV::NAME_Offset, /* Enabled */ true, InOutPropertyRows);
	AddTextureUVDynamicPropertyRow(InComponentEditWidget, TextureUVDynamic, UDMTextureUV::NAME_Rotation, /* Enabled */ true, InOutPropertyRows);
	AddTextureUVDynamicPropertyRow(InComponentEditWidget, TextureUVDynamic, UDMTextureUV::NAME_Tiling, /* Enabled */ true, InOutPropertyRows);
	AddTextureUVDynamicPropertyRow(InComponentEditWidget, TextureUVDynamic, UDMTextureUV::NAME_Pivot, /* Enabled */ true, InOutPropertyRows);
	AddTextureUVDynamicPropertyRow(InComponentEditWidget, TextureUV, UDMTextureUV::NAME_bMirrorOnX, /* Enabled */ false, InOutPropertyRows);
	AddTextureUVDynamicPropertyRow(InComponentEditWidget, TextureUV, UDMTextureUV::NAME_bMirrorOnY, /* Enabled */ false, InOutPropertyRows);
	AddTextureUVDynamicVisualizerRow(InComponentEditWidget, TextureUVDynamic, InOutPropertyRows);
}
...
void UE::DynamicMaterialEditor::Private::AddTextureUVDynamicPropertyRow(const TSharedRef<SWidget>& InComponentEditWidget, 
	UDMMaterialComponent* InTextureUVDynamic, FName InProperty, bool bInEnabled, TArray<FDMPropertyHandle>& InOutPropertyRows)
{
	FDMPropertyHandle& NewHandle = InOutPropertyRows.Add_GetRef(SDMEditor::GetPropertyHandle(&*InComponentEditWidget, InTextureUVDynamic, InProperty));
...
void UE::DynamicMaterialEditor::Private::AddTextureUVDynamicVisualizerRow(const TSharedRef<SWidget>& InComponentEditWidget, UDMTextureUVDynamic* InTextureUVDynamic,
	TArray<FDMPropertyHandle>& InOutPropertyRows)
{
