...
private:
	void RegisterOutlineColorColumnToActor(ITypedElementDataStorageInterface& DataStorage) const;
	void RegisterOverlayColorColumnToActor(ITypedElementDataStorageInterface& DataStorage) const;
};
