...
class MIXERINSIGHT_API T_TiledGrid
{
public:
	using Size = DimType;
	using Index = int32_t;
...
class MIXERINSIGHT_API T_Tiled
{
public:
...
/// DeviceBuffer Record
///
class MIXERINSIGHT_API DeviceBufferRecord
{
public:
...
/// Blob Record 
class MIXERINSIGHT_API BlobRecord
{
public:
	// adding a default constructor to enforce this to be a non POD class to successfully initialize
	BlobRecord() {}
...
class MIXERINSIGHT_API JobRecord
{
public:
	// adding a default constructor to enforce this to be a non POD class to successfully initialize
	JobRecord() {}
...
class MIXERINSIGHT_API BatchRecord
{
public:
	// adding a default constructor to enforce this to be a non POD class to successfully initialize
	BatchRecord() {}
...
class MIXERINSIGHT_API ActionRecord
{
public:
	// adding a default constructor to enforce this to be a non POD class to successfully initialize
	ActionRecord() {}
...
class MIXERINSIGHT_API MixRecord
{
public:
	// adding a default constructor to enforce this to be a non POD class to successfully initialize
	MixRecord() {}
...
class MIXERINSIGHT_API SessionRecord
{
private:
