...
#include "Model/MixerInsightRecord.h"
#include <Widgets/Layout/SBorder.h>
#include <UObject/GCObject.h>

class UMaterialInstanceDynamic;

class MIXERINSIGHT_API SMixerInsightDeviceBufferView : public SBorder, public FGCObject /// Need FGCObject to control garbage collection of objects
{
public:
	SLATE_BEGIN_ARGS(SMixerInsightDeviceBufferView) :
		_withToolTip(false),
	...
	{
		return TEXT("SMixerInsightDeviceBufferView");
	}
};
