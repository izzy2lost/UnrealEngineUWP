...
class MIXERINSIGHT_API SMixerInsightBlobView : public SBorder, public FGCObject /// Need FGCObject to control garbage collection of objects
{
public:
	SLATE_BEGIN_ARGS(SMixerInsightBlobView) :
	...
	{
		return TEXT("SMixerInsightBlobView");
	}
