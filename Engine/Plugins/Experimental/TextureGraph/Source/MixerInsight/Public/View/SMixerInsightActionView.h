...
class SMixerInsightActionViewRow; /// Declare the concrete type of widget used for the raws of the view. Defined in the cpp file

class MIXERINSIGHT_API SMixerInsightActionView : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SMixerInsightActionView) {}
	SLATE_END_ARGS()
	...
	public:
		...
		TSharedPtr < SMixerInsightActionViewRow > _widget;
		RecordID _recordID;
