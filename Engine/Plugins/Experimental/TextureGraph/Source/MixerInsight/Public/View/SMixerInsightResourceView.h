...
class SMixerInsightResourceViewRow; /// Declare the concrete type of widget used for the raws of the view. Defined in the cpp file
class ITableRow;
class STableViewBase;

class MIXERINSIGHT_API SMixerInsightResourceView : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SMixerInsightResourceView) {}
	SLATE_END_ARGS()
	...
	public:
		...
		TSharedPtr < SMixerInsightResourceViewRow > _widget;
		RecordID _recordID;
