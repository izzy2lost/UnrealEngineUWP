...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "TextureGraph", meta = (Keywords = "SetOutputSettingsParameterValue", WorldContext = "WorldContextObject"))
	static void SetOutputSettingsParameterValue(UObject* WorldContextObject, UTextureGraph* TextureScript, FName ParameterName, int Width,int Height, FString FileName = "None", FString FolderPath = "None", ETG_TextureFormat Format = ETG_TextureFormat::BGRA8);
	...
	static FTG_OutputSettings GetOutputSettingsParameterValue(UObject* WorldContextObject, UTextureGraph* TextureScript, FName ParameterName);
