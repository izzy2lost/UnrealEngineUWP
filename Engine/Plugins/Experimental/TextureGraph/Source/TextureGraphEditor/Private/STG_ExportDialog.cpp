...
void STG_ExportDialog::Construct(const FArguments& InArgs, UTextureGraph* InSourceTextureGraph)
{
	SourceTextureGraph = InSourceTextureGraph;
	...
	// MainPropertyView->OnFinishedChangingProperties().AddSP(this, &STG_ExportDialog::OnFinishedChangingProperties);
	//
	// DetailsPropertyView = EditModule.CreateDetailView(DetailsViewArgs);
	// DetailsPropertyView->OnFinishedChangingProperties().AddSP(this, &STG_ExportDialog::OnFinishedChangingProperties);
	//
	...
	[
		...
		[
			...
			// 			.OnClicked(this, &STG_ExportDialog::ExtractClicked)
			// 		]
			...
			// 			.OnClicked(this, &STG_ExportDialog::CancelClicked)
			// 		]
			// 	]
			// ]
		]
...
STG_ExportDialog::~STG_ExportDialog()
{
...
bool STG_ExportDialog::ShowWindow(UTextureGraph* SourceTextureGraph)
{
	const FText TitleText = NSLOCTEXT("TextureGraph", "TextureGraph_Export", "Export Texture Graph");
	// Create the window to pick the class
	TSharedRef<SWindow> ExportTextureGraphWindow = SNew(SWindow)
		.Title(TitleText)
	...
	TSharedRef<STG_ExportDialog> ExportTextureGraphDialog = SNew(STG_ExportDialog, SourceTextureGraph);

	ExportTextureGraphWindow->SetContent(ExportTextureGraphDialog);
	TSharedPtr<SWindow> RootWindow = FGlobalTabmanager::Get()->GetRootWindow();
	if (RootWindow.IsValid())
	{
		FSlateApplication::Get().AddWindowAsNativeChild(ExportTextureGraphWindow, RootWindow.ToSharedRef());
	}
	else
	{
		FSlateApplication::Get().AddWindow(ExportTextureGraphWindow);
	}
...
// void STG_ExportDialog::PreviewExtractedSprites()
// {
...
// }
//
// void STG_ExportDialog::OnFinishedChangingProperties(const FPropertyChangedEvent& PropertyChangedEvent)
// {
...
// }
//
// FReply STG_ExportDialog::ExtractClicked()
// {
...
// }
//
// FReply STG_ExportDialog::CancelClicked()
// {
// 	CloseContainingWindow();
// 	return FReply::Handled();
// }
//
// void STG_ExportDialog::CloseContainingWindow()
// {
...
// }
//
// void STG_ExportDialog::CreateExtractedSprites()
// {
...
// }
//
// void STG_ExportDialog::SetDetailsViewForActiveMode()
// {
