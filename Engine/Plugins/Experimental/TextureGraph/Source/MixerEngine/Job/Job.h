...
//////////////////////////////////////////////////////////////////////////
class MIXERENGINE_API Job : public DeviceNativeTask
{
public:
	struct JobStats
	{
...
protected:
	...
	FWeakObjectPtr					ErrorOwner;			/// Error owner is an object associated with any error reported to the MixerEngine::ErrorReporter during this job execution
