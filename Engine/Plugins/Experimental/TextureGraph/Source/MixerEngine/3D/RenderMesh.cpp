...
void RenderMesh::SetMaterial(UMaterialInterface* mat)
{
	...
	try
	{
		for (int i = 0; i < _meshActors.Num();i++)
		{
			...
			{
				//UMixerEngineGameInstance::ReportError(FText::FromStringTable("/MixerEditor/UI/StringTables/LocalizationTable.LocalizationTable", "Error"), FText::FromStringTable("/MixerEditor/UI/StringTables/LocalizationTable.LocalizationTable", "SomethingWrongTryAgain"));
