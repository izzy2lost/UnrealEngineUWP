...
//////////////////////////////////////////////////////////////////////////
class MIXERENGINE_API VSH_Base : public FGlobalShader
{
public:
...
//////////////////////////////////////////////////////////////////////////
class MIXERENGINE_API FSH_Base : public FGlobalShader
{
public:
...
class MIXERENGINE_API CmpSH_Base : public FGlobalShader
{
public:
...
////////////////////////////////////////////////////////////////////////////
class MIXERENGINE_API VSH_Simple : public VSH_Base
{
public:
...
////////////////////////////////////////////////////////////////////////////
class MIXERENGINE_API FSH_Simple : public FSH_Base
{
public:
...
//////////////////////////////////////////////////////////////////////////
class MIXERENGINE_API FSH_SimpleVT : public FSH_Base
{
public:
...
//////////////////////////////////////////////////////////////////////////
class MIXERENGINE_API QuadScreenBuffer : public FVertexBuffer
{
	void							InitRHI(FRHICommandListBase& RHICmdList) override;
};

//////////////////////////////////////////////////////////////////////////
class MIXERENGINE_API FxMaterial
{
public:
	struct MemberInfo
	{
...
#define DECLARE_EMPTY_GLOBAL_SHADER_DERIVED_FROM(Name, BaseName) class MIXERENGINE_API Name : public BaseName \
{ \
public: \
...
#define MIXER_ENGINE_DEFAULT_PERMUTATION \
static bool	ShouldCompilePermutation(const FGlobalShaderPermutationParameters& Parameters) \
{ \
	return IsPCPlatform(Parameters.Platform) && EnumHasAllFlags(Parameters.Flags, EShaderPermutationFlags::HasEditorOnlyData); \
}

#define MIXER_ENGINE_DEFAULT_COMPILATION_ENV \
static void						ModifyCompilationEnvironment(const FGlobalShaderPermutationParameters& params, FShaderCompilerEnvironment& env) {}
