...
IMPLEMENT_MATERIAL_SHADER_TYPE(, FMixerMaterialShaderVS, TEXT("/Plugin/TextureGraph/MixerMaterialShader.usf"), TEXT("MixerMaterialShaderVS"), SF_Vertex);

IMPLEMENT_MATERIAL_SHADER_TYPE(, FMixerMaterialShaderPS, TEXT("/Plugin/TextureGraph/MixerMaterialShader.usf"), TEXT("MixerMaterialShaderPS"), SF_Pixel);

FName FMixerMaterialShaderPS::PSCONTROL_ARG = TEXT("PSControl");
