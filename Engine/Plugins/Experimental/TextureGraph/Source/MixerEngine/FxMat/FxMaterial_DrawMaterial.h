...
class MIXERENGINE_API FMixerMaterialShaderVS : public FMaterialShader
{
public:
	DECLARE_SHADER_TYPE(FMixerMaterialShaderVS, Material)

	//using FParameters = FMixerMaterialShaderParameters;
	BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
	END_SHADER_PARAMETER_STRUCT()

	SHADER_USE_PARAMETER_STRUCT_WITH_LEGACY_BASE(FMixerMaterialShaderVS, FMaterialShader);
...
class MIXERENGINE_API FMixerMaterialShaderPS : public FMaterialShader
{
public:
	DECLARE_SHADER_TYPE(FMixerMaterialShaderPS, Material)
	...
	SHADER_USE_PARAMETER_STRUCT_WITH_LEGACY_BASE(FMixerMaterialShaderPS, FMaterialShader);
...
typedef FxMaterial_DrawMaterial< FMixerMaterialShaderVS, FMixerMaterialShaderPS> FxMaterial_QuadDrawMaterial;
