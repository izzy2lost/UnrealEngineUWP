...
{
	RenderMaterial_FXPtr RenderMaterial = MixerEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_TransformBlit>(TEXT("T_TransformBlit"));
	...
	FString Name = FString::Printf(TEXT("TransformBlit.[%llu]"), Cycle->GetBatch()->GetBatchId());
