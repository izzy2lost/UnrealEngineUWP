...
RenderMaterial_FXPtr GetIfThenElseMaterial(EIfThenElseOperator Operator, EIfThenElseType Type)
{
	...
	case EIfThenElseOperator::GT:
		if (Type == EIfThenElseType::IndividualComponent)
			return MixerEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_GT_Component>("FSH_IfThenElse_GT_Component");
		else if (Type == EIfThenElseType::AllComponents)
			return MixerEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_GT_All>("FSH_IfThenElse_GT_All");
		else if (Type == EIfThenElseType::Grayscale)
			return MixerEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_GT_Grayscale>("FSH_IfThenElse_GT_Grayscale");
		break;

		
	case EIfThenElseOperator::LT:
		if (Type == EIfThenElseType::IndividualComponent)
			return MixerEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_LT_Component>("FSH_IfThenElse_LT_Component");
		else if (Type == EIfThenElseType::AllComponents)
			return MixerEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_LT_All>("FSH_IfThenElse_LT_All");
		else if (Type == EIfThenElseType::Grayscale)
			return MixerEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_LT_Grayscale>("FSH_IfThenElse_LT_Grayscale");
		break;
		
	case EIfThenElseOperator::EQ:
		if (Type == EIfThenElseType::IndividualComponent)
			return MixerEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_EQ_Component>("FSH_IfThenElse_EQ_Component");
		else if (Type == EIfThenElseType::AllComponents)
			return MixerEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_EQ_All>("FSH_IfThenElse_EQ_All");
		else if (Type == EIfThenElseType::Grayscale)
			return MixerEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_EQ_Grayscale>("FSH_IfThenElse_EQ_Grayscale");
		break;
		
	case EIfThenElseOperator::NEQ:
		if (Type == EIfThenElseType::IndividualComponent)
			return MixerEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_NEQ_Component>("FSH_IfThenElse_NEQ_Component");
		else if (Type == EIfThenElseType::AllComponents)
			return MixerEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_NEQ_All>("FSH_IfThenElse_NEQ_All");
		else if (Type == EIfThenElseType::Grayscale)
			return MixerEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_NEQ_Grayscale>("FSH_IfThenElse_NEQ_Grayscale");
		break;
	}
