...
class MIXERENGINE_API FSH_BrightnessMaskModifier : public FSH_Base
{
public:
...
class MIXERENGINE_API FSH_ClampMaskModifier : public FSH_Base
{
public:
...
class MIXERENGINE_API FSH_InvertMaskModifier : public FSH_Base
{
public:
...
class MIXERENGINE_API FSH_NormalizeMaskModifier : public FSH_Base
{
public:
...
class MIXERENGINE_API FSH_GradientRemapMaskModifier : public FSH_Base
{
public:
...
class MIXERENGINE_API FSH_PosterizeMaskModifier : public FSH_Base
{
public:
 ...
 * 
 */
class MIXERENGINE_API T_MaskModifier
{
public:
	T_MaskModifier();
	~T_MaskModifier();
