	...
	EShapeMaskType ShapeType, const FParams& Params, int32 TargetId)
{
	...
	const RenderMaterial_FXPtr RenderMaterial = MixerEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_ShapeMask>(TEXT("T_ShapeMask"), PermutationVector);
