...
DECLARE_LOG_CATEGORY_EXTERN(LogMixerEngine, Log, All);
class UMixInterface;
class UAppState;
class ULayerStack;
...
//////////////////////////////////////////////////////////////////////////
class FMixerEngineModule : public FDefaultGameModuleImpl
{
private:
	FString												_libPath;
	FString												_pluginName;
...
typedef std::shared_ptr<FMixerErrorReporter>			ErrorReporterPtr;
...
//////////////////////////////////////////////////////////////////////////
class MIXERENGINE_API MixerEngine
{
private:
	static MixerEngine*									GInstance;					/// Static instance. Use Create to create a new instance. Destroy the current instance first
	...
	explicit											MixerEngine(bool bInIsTestMode);
	...
	MixerEditor::RenderDocManagerPtr					RenderDocMgrObj;			/// The RenderDoc manager that we have
...
public:
	...
	FORCEINLINE static MixerEngine*						GetInstance() { return GInstance; }
	...
	FORCEINLINE static MixerEditor::RenderDocManager*	GetRenderDocManager() { return GInstance ? GInstance->RenderDocMgrObj.get() : nullptr; }
	...
	FORCEINLINE static FMixerErrorReporter*				GetErrorReporter(UMixInterface* MixKey) { return GInstance ? GInstance->ErrorReporters.Find(MixKey)->get() : nullptr; }
};
