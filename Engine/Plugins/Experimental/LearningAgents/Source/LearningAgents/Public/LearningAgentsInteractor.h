...
public:
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, Category = "LearningAgents", Meta = (ForceAsFunction))
	void PerformAgentAction(const FLearningAgentsActionObjectElement& InActionObjectElement, const ULearningAgentsActionObject* InActionObject, const int32 AgentId);
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, Category = "LearningAgents", Meta = (ForceAsFunction))
	void PerformAgentActions(const TArray<FLearningAgentsActionObjectElement>& InActionObjectElements, const ULearningAgentsActionObject* InActionObject, const TArray<int32>& AgentIds);
