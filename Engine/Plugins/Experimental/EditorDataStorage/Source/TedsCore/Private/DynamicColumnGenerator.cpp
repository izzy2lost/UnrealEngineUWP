...
UE::EditorDataStorage::FDynamicColumnGeneratorInfo UE::EditorDataStorage::FDynamicColumnGenerator::GenerateColumn(const FName& ColumnName, const UScriptStruct& Template)
{
...
const UScriptStruct* UE::EditorDataStorage::FDynamicColumnGenerator::LookupColumn(const FName& ColumnName) const
{
...
UE::EditorDataStorage::FDynamicTagManager::FDynamicTagManager(FDynamicColumnGenerator& InColumnGenerator)
	: ColumnGenerator(InColumnGenerator)
{
}

FConstSharedStruct UE::EditorDataStorage::FDynamicTagManager::GenerateDynamicTag(const FDynamicTag& InTag, const FName& InValue)
{
	...
	// 
	{
		...
		const FTypedElementDataStorageDynamicTagTemplate Overlay
		{
			.Value = InValue
		};
...
const UScriptStruct* UE::EditorDataStorage::FDynamicTagManager::GenerateColumnType(const FDynamicTag& Tag)
{
	const FDynamicColumnGeneratorInfo GeneratedColumnType = ColumnGenerator.GenerateColumn(Tag.GetName(), *FTypedElementDataStorageDynamicTagTemplate::StaticStruct());
