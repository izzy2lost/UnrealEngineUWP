...
namespace UE::Editor::DataStorage
{
	namespace Tests
	{
		TableHandle RegisterTestTableA(ITypedElementDataStorageInterface* TedsInterface)
		{
		...
		void TypedElementDataStorageTestsFixture::Define()
		{
			...
			Describe("", [this]()
			{
				...
				Describe("", [this]()
				{
					...
					Describe("BatchAddRow(TableHandle, int32, TypedElementDataStorageCreationCallbackRef)", [this]()
					{
						for (int32 RowCount = 1; RowCount <= 2; ++RowCount)
						{
