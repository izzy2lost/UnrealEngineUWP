...
void FChaosClothAssetSimulationBendingConfigNode::AddProperties(FPropertyHelper& PropertyHelper) const
{
	...
	if(!CanUseFabrics(ClothFacade))
	{
		if(SolverType == EChaosClothAssetConstraintSolverType::XPBD)
		{
			...
			{
				PropertyHelper.SetPropertyWeighted(FName(TEXT("XPBDAnisoBendingStiffnessWarp")), BendingStiffnessWarp, {
					FName(TEXT("BendingSpringStiffness")),     
					FName(TEXT("BendingElementStiffness")),     
					FName(TEXT("XPBDBendingSpringStiffness")),  
					FName(TEXT("XPBDBendingElementStiffness"))});
				
				PropertyHelper.SetPropertyWeighted(FName(TEXT("XPBDAnisoBendingStiffnessWeft")), BendingStiffnessWeft, {});
				PropertyHelper.SetPropertyWeighted(FName(TEXT("XPBDAnisoBendingStiffnessBias")), BendingStiffnessBias, {});

				PropertyHelper.SetPropertyWeighted(FName(TEXT("XPBDAnisoBucklingStiffnessWarp")), BucklingStiffnessWarp, {
					FName(TEXT("BucklingStiffness")),    
					FName(TEXT("XPBDBucklingStiffness"))});
				
				PropertyHelper.SetPropertyWeighted(FName(TEXT("XPBDAnisoBucklingStiffnessWeft")), BucklingStiffnessWeft, {});
				PropertyHelper.SetPropertyWeighted(FName(TEXT("XPBDAnisoBucklingStiffnessBias")), BucklingStiffnessBias, {});

				PropertyHelper.SetPropertyWeighted(FName(TEXT("XPBDAnisoBendingDamping")), BendingDamping, {
					FName(TEXT("XPBDBendingSpringDamping")),  
					FName(TEXT("XPBDBendingElementDamping"))});
	...
	else
	{
		...
		SetFabricPropertyWeighted(FName(TEXT("XPBDAnisoBendingDamping")), BendingDamping, ClothFacade, PropertyHelper, [](
			const UE::Chaos::ClothAsset::FCollectionClothFabricFacade& FabricFacade)-> float
		{
		...
		SetFabricProperty(FName(TEXT("XPBDAnisoBucklingRatio")), ClothFacade, PropertyHelper, [](const UE::Chaos::ClothAsset::FCollectionClothFabricFacade& FabricFacade)-> float
		 {
			return FabricFacade.GetXPBDAnisoBucklingRatio();
		 }, {
			FName(TEXT("BucklingRatio")),
			FName(TEXT("XPBDBucklingRatio"))});
