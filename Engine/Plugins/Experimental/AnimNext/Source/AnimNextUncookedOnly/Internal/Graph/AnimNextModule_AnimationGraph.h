...
#include "AnimNextModule_AnimationGraph.generated.h"
...
class UAnimNextModule_AnimationGraph : public UAnimNextRigVMAssetEntry, public IAnimNextRigVMGraphInterface, public IAnimNextRigVMExportInterface
{
	GENERATED_BODY()
