...
void UAnimNextGraph_EdGraphNode::GetNodeContextMenuActions(UToolMenu* Menu, class UGraphNodeContextMenuContext* Context) const
{
	...
	if (IsTraitStack())
	{
		...
		Section.AddSubMenu(
			...
			FNewToolMenuDelegate::CreateUObject(NonConstThis, &UAnimNextGraph_EdGraphNode::BuildAddTraitContextMenu));
	}
}
...
bool UAnimNextGraph_EdGraphNode::IsTraitStack() const
{
...
void UAnimNextGraph_EdGraphNode::BuildAddTraitContextMenu(UToolMenu* SubMenu)
{
