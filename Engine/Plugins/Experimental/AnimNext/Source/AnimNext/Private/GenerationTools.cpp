	...
	if (NumLODs > 0)
	{
		...
		if (bCanGenerateSingleBonesList)
		{
			...
			if (bCanGenerateSingleBonesList)
			{
				...
				const int32 SkeletonToMeshLinkupTableSize = LinkupTable.SkeletonToMeshTable.Num();
				...
				SkeletonBoneIndexToLODBoneIndexMap.Init(INDEX_NONE, SkeletonToMeshLinkupTableSize);
