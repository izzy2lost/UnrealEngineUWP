...
class FModuleEditor : public FWorkflowCentricApplication
{
public:
	/** Edits the specified asset */
	void InitEditor(const EToolkitMode::Type InMode, const TSharedPtr<IToolkitHost>& InInitToolkitHost, UAnimNextModule* InAnimNextModule);

private:
	friend class FModuleEditorMode;
	...
	UAnimNextModule_EditorData* AnimNextModule_EditorData = nullptr;
