...
public:
	/** True if the Controller can't send DMX data */
	...
	FORCEINLINE static FName GetIsMutedPropertyName() { return GET_MEMBER_NAME_CHECKED(UDMXControlConsoleControllerBase, bIsMuted); }
...
protected:
	/** If true, the Controller doesn't send DMX */
