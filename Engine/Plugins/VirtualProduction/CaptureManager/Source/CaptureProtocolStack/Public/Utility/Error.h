...
class CAPTUREPROTOCOLSTACK_API FCaptureProtocolError
{
public:
...
#define CPS_CHECK_VOID_RESULT(Function) if (TProtocolResult<void> Result = Function; Result.HasError()) { return Result.StealError(); }