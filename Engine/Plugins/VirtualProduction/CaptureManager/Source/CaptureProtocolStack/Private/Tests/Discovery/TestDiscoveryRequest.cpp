...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TDiscoveryRequestDeserializeTest, "Plugin.CaptureProtocolStack.Discovery.DiscoveryRequest.Deserialize.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TDiscoveryRequestDeserializeTestInvalidMessageType, "Plugin.CaptureProtocolStack.Discovery.DiscoveryRequest.Deserialize.InvalidMessageType", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TDiscoveryRequestSerializeTest, "Plugin.CaptureProtocolStack.Discovery.DiscoveryRequest.Serialize.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
