...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlPacketDeserializeOneTest, "Plugin.CaptureProtocolStack.Control.ControlPacket.DeserializeOne.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlPacketDeserializeOneTestInvalidHeader, "Plugin.CaptureProtocolStack.Control.ControlPacket.DeserializeOne.InvalidHeader", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlPacketDeserializeMoreTest, "Plugin.CaptureProtocolStack.Control.ControlPacket.DeserializeMore.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlPacketSerializeOneTest, "Plugin.CaptureProtocolStack.Control.ControlPacket.SerializeOne.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlPacketSerializeOneTestFailed, "Plugin.CaptureProtocolStack.Control.ControlPacket.SerializeOne.Failure", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
