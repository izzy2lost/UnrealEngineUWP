...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlMessageDeserializeTest, "Plugin.CaptureProtocolStack.Control.ControlMessage.Deserialize.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlMessageDeserializeTestInvalidPayload, "Plugin.CaptureProtocolStack.Control.ControlMessage.DeserializeOne.InvalidPayload", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlMessageDeserializeSessionIdMissingTest, "Plugin.CaptureProtocolStack.Control.ControlMessage.Deserialize.SessionIdMissing", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlMessageDeserializeTransactionIdMissingTest, "Plugin.CaptureProtocolStack.Control.ControlMessage.Deserialize.TransactionIdMissing", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlMessageDeserializeTimestampMissingTest, "Plugin.CaptureProtocolStack.Control.ControlMessage.Deserialize.TimestampMissing", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlMessageDeserializeTypeMissingTest, "Plugin.CaptureProtocolStack.Control.ControlMessage.Deserialize.TypeMissing", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlMessageDeserializeAddressPathMissingTest, "Plugin.CaptureProtocolStack.Control.ControlMessage.Deserialize.AddressPathMissing", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlMessageSerializeTest, "Plugin.CaptureProtocolStack.Control.ControlMessage.Serialize.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
