...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TExportResponseDeserializeOneTest, "Plugin.CaptureProtocolStack.Export.ExportResponse.DeserializeOne.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TExportResponseDeserializeOneTestInvalidSize, "Plugin.CaptureProtocolStack.Export.ExportResponse.DeserializeOne.InvalidSize", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TExportResponseSerializeOneTest, "Plugin.CaptureProtocolStack.Export.ExportResponse.SerializeOne.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TExportResponseSerializeOneTestError, "Plugin.CaptureProtocolStack.Export.ExportResponse.SerializeOne.Error", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
