...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlJsonUtilitiesParseNumber, "Plugin.CaptureProtocolStack.Control.ControlJsonUtilities.ParseNumber.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlJsonUtilitiesParseNumberMissingField, "Plugin.CaptureProtocolStack.Control.ControlJsonUtilities.ParseNumber.MissingField", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlJsonUtilitiesParseString, "Plugin.CaptureProtocolStack.Control.ControlJsonUtilities.ParseString.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlJsonUtilitiesParseStringMissingField, "Plugin.CaptureProtocolStack.Control.ControlJsonUtilities.ParseString.MissingField", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlJsonUtilitiesParseBool, "Plugin.CaptureProtocolStack.Control.ControlJsonUtilities.ParseBool.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlJsonUtilitiesParseBoolMissingField, "Plugin.CaptureProtocolStack.Control.ControlJsonUtilities.ParseString.MissingField", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlJsonUtilitiesParseObject, "Plugin.CaptureProtocolStack.Control.ControlJsonUtilities.ParseObject.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlJsonUtilitiesParseObjectMissingField, "Plugin.CaptureProtocolStack.Control.ControlJsonUtilities.ParseObject.MissingField", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlJsonUtilitiesParseArray, "Plugin.CaptureProtocolStack.Control.ControlJsonUtilities.ParseArray.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlJsonUtilitiesParseArrayMissingField, "Plugin.CaptureProtocolStack.Control.ControlJsonUtilities.ParseArray.MissingField", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlJsonUtilitiesCreateJsonFromData, "Plugin.CaptureProtocolStack.Control.ControlJsonUtilities.CreateJsonFromData.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlJsonUtilitiesCreateJsonFromDataFail, "Plugin.CaptureProtocolStack.Control.ControlJsonUtilities.CreateJsonFromData.Failure", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TControlJsonUtilitiesCreateDataFromJson, "Plugin.CaptureProtocolStack.Control.ControlJsonUtilities.CreateDataFromJson.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
