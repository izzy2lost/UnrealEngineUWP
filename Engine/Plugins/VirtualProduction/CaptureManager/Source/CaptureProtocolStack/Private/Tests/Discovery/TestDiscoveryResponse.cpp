...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TDiscoveryResponseDeserializeTest, "Plugin.CaptureProtocolStack.Discovery.DiscoveryResponse.Deserialize.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TDiscoveryResponseDeserializeTestInvalidMessageType, "Plugin.CaptureProtocolStack.Discovery.DiscoveryResponse.Deserialize.InvalidMessageType", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TDiscoveryResponseDeserializeTestInvalidSize, "Plugin.CaptureProtocolStack.Discovery.DiscoveryResponse.Deserialize.InvalidSize", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TDiscoveryResponseSerializeTest, "Plugin.CaptureProtocolStack.Discovery.DiscoveryResponse.Serialize.Success", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
