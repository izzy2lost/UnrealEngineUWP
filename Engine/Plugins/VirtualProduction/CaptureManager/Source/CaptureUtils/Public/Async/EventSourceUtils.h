...
class CAPTUREUTILS_API FCaptureEventSource : public UE::CaptureManager::Private::FCaptureEventSourceBase
{
protected:
...
private:
	using UE::CaptureManager::Private::FCaptureEventSourceBase::PublishEventInternal;
};
...
class CAPTUREUTILS_API FCaptureEventSourceWithLimiter : public UE::CaptureManager::Private::FCaptureEventSourceBase
{
public:
