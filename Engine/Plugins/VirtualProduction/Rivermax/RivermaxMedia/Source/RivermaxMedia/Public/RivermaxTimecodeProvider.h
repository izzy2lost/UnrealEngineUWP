 ...
 * Timecode going out of GrandMaster is generally using UTC time reference so to generate an engine timecode
 ...
 * 
 * GrandMasters can also output timecode with daylight saving time (DST) offsets which would not be affecting PTP time reference
...
public:
	...
	/** 
	 * If timecode generated by grand master has daylight saving applied, add offset here in order to match PTP based timecode with devices getting LTC timecode 
