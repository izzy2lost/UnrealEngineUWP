...
namespace UE::VCamCore
{
	...
	BEGIN_DEFINE_SPEC(FViewportManagerSpec, "VirtualProduction.VCam.Viewport.Manager", EAutomationTestFlags::EngineFilter | EAutomationTestFlags::ApplicationContextMask)
