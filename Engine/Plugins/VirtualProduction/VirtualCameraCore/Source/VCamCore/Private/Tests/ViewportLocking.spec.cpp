...
namespace UE::VCamCore
{
	...
	BEGIN_DEFINE_SPEC(FViewportLockingSpec, "VirtualProduction.VCam.Viewport.Locking", EAutomationTestFlags::EngineFilter | EAutomationTestFlags::ApplicationContextMask)
