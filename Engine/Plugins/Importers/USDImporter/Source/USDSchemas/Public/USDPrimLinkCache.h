...
#include "USDPrimLinkCache.generated.h"
...
UCLASS()
class USDSCHEMAS_API UUsdPrimLinkCache : public UObject
{
	GENERATED_BODY()

public:
	struct UUsdPrimLinkCacheImpl;

	UUsdPrimLinkCache();
	UUsdPrimLinkCache(FVTableHelper& Helper);
	virtual ~UUsdPrimLinkCache() override;
...
private:
	TUniquePtr<UUsdPrimLinkCacheImpl> Impl;
};
