...
void 
UE::SimCacheUSDUtil::Private::SaveStage(
...
void 
UE::SimCacheUSDUtil::Private::DefineAncestorTransforms(
...
void
UE::SimCacheUSDUtil::Private::ComputeExtent(
...
bool 
UE::SimCacheUSDUtil::Private::SetPointsExtentAndPrimXform(
	pxr::UsdPrim& Prim, 
	...
	const pxr::UsdTimeCode& Time)
{
	...
	UE::SimCacheUSDUtil::Private::ComputeExtent(Points, Extent);
	...
	const pxr::UsdTimeCode& Time)
{
	...
	return UE::SimCacheUSDUtil::Private::SetPointsExtentAndPrimXform(Prim, PrimXf, Points, Vels, Time);
}
