...
struct hid_device_info HID_API_EXPORT * HID_API_CALL hid_enumerate(unsigned short vendor_id, unsigned short product_id)
{
	...
	for (;;) {
		...
		if ((vendor_id == 0x0 || attrib.VendorID == vendor_id) &&
			...
			res1 = HidD_GetPreparsedData(write_handle, &pp_data);
			if (res1) {
			...
			/* Serial Number */
			res1 = HidD_GetSerialNumberString(write_handle, wstr, sizeof(wstr));
			...
			/* Manufacturer String */
			res1 = HidD_GetManufacturerString(write_handle, wstr, sizeof(wstr));
			wstr[WSTR_LEN-1] = 0x0000;
			if (res1) {
			...
			/* Product String */
			res1 = HidD_GetProductString(write_handle, wstr, sizeof(wstr));
			wstr[WSTR_LEN-1] = 0x0000;
			if (res1) {
