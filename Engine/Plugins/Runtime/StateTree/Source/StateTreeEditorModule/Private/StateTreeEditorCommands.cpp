...
void FStateTreeEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(LogResultOnCompileSuccess, "Log compilation result", "After a StateTree compiles, log the internal content of the StateTree.", EUserInterfaceActionType::ToggleButton, FInputChord());
