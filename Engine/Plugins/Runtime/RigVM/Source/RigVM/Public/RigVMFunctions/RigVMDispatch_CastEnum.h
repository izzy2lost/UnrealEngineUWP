...
struct RIGVM_API FRigVMDispatch_CastEnum : public FRigVMDispatchFactory, public FRigVMDispatch_CastEnumBase
{
	GENERATED_BODY()

public:
	FRigVMDispatch_CastEnum()
	{
...
protected:
	virtual FRigVMFunctionPtr GetDispatchFunctionImpl(const FRigVMTemplateTypeMap& InTypes) const override { return &FRigVMDispatch_CastEnum::Execute; }
