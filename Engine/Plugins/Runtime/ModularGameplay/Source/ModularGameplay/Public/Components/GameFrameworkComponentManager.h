...
enum class EGameFrameworkAddComponentFlags : uint8
{
	...
	ReplaceParents =			0b00001000	UMETA(DisplayName = "Replace Parents", ToolTip = "If ReplaceParents is set, it will remove all parent class components of ComponentClass when it is added. Note: ReplaceParents will supersede other 'AddUnique...' flags."),
	ReplaceCopiesAndChildren =	0b00010000	UMETA(DisplayName = "Replace Copies And Children", ToolTip = "If ReplaceCopiesAndChildren is set, it will remove all components of ComponentClass when it is added. Note: ReplaceCopiesAndChildren will supersede other 'AddUnique...' flags."),
};
