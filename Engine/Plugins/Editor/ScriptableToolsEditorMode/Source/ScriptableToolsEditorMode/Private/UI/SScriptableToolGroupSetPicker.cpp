...
void SScriptableToolGroupSetPicker::Construct(const FArguments& InArgs)
{
	...
	{
		StructPropertyHandle->SetOnPropertyValueChanged(FSimpleDelegate::CreateSP(this, &SScriptableToolGroupSetPicker::PopulateCheckedTags));
	}
...
TSharedRef<SWidget> SScriptableToolGroupSetPicker::GetChildWidget()
{
	const TSharedRef<SWidget> MenuContent = SNew(SBox)
		...
		.OnTextChanged(this, &SScriptableToolGroupSetPicker::OnSearchStringChanged)
		]
	...
	+ SVerticalBox::Slot()
		...
		.OnGenerateRow(this, &SScriptableToolGroupSetPicker::OnGenerateRow)
	...
	MenuBuilder.AddMenuEntry(
		...
		FUIAction(FExecuteAction::CreateRaw(this, &SScriptableToolGroupSetPicker::OnUncheckAllTags))
	);
...
TSharedRef<ITableRow> SScriptableToolGroupSetPicker::OnGenerateRow(UClass* InTag, const TSharedRef<STableViewBase>& OwnerTable)
{
...
void SScriptableToolGroupSetPicker::OnSearchStringChanged(const FText& NewString)
{
	SearchString = NewString.ToString();
	RefreshListView();
}

void SScriptableToolGroupSetPicker::RefreshListView()
{
...
void SScriptableToolGroupSetPicker::PopulateVisibleClasses()
{
...
void SScriptableToolGroupSetPicker::ForceUpdate()
{
	PopulateCheckedTags();
}

void SScriptableToolGroupSetPicker::PopulateCheckedTags()
{
...
ECheckBoxState SScriptableToolGroupSetPicker::IsTagChecked(UClass* InTag)
{
...
void SScriptableToolGroupSetPicker::OnTagChecked(UClass* InTag)
{
...
void SScriptableToolGroupSetPicker::OnTagUnchecked(UClass* InTag)
{
...
void SScriptableToolGroupSetPicker::OnUncheckAllTags()
{
...
void SScriptableToolGroupSetPicker::OnCreateNewTag()
{
...
void SScriptableToolGroupSetPicker::FlushHelperGroupSet() const
{
	if (StructPropertyHandle.IsValid() && StructPropertyHandle->IsValidHandle() && !StructPtr)
	{
