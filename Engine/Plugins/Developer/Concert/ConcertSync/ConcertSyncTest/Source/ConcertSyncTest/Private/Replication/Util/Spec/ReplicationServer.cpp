...
{
	FReplicationServer::FReplicationServer(FAutomationTestBase& TestContext)
		: TestContext(TestContext)
		, ServerSessionMock(MakeShared<FConcertServerSessionMock>())
		, ServerReplicationManager(ConcertSyncServer::TestInterface::CreateServerReplicationManager(ServerSessionMock))
	{}
	...
	FReplicationClient& FReplicationServer::ConnectClient()
	{
		...
		Clients.Add(MakeUnique<FReplicationClient>(ClientEndpointId, *ServerSessionMock, TestContext));
