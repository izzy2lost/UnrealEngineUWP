...
#include "Replication/Editor/View/ObjectViewer/SPropertyReplicationSelectionViewer.h"
...
namespace UE::ConcertClientSharedSlate
{
	 ...
	 */
	class CONCERTCLIENTSHAREDSLATE_API SPropertyReplicationSelectionEditor : public SPropertyReplicationSelectionViewer
	{
	public:
