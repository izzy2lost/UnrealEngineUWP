...
#include "Replication/Editor/View/ObjectViewer/SelectionViewerColumns.h"
...
namespace UE::ConcertClientSharedSlate
{
	 ...
	 */
	class CONCERTCLIENTSHAREDSLATE_API SPropertyReplicationSelectionViewer : public SCompoundWidget
	{
	public:
