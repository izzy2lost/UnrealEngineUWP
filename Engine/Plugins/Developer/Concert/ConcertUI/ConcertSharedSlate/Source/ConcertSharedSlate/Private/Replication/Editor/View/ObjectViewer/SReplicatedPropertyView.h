...
namespace UE::ConcertSharedSlate
{
	...
	public:
		...
		TSet<FSoftObjectPath> GetObjectsSelectedForPropertyEditing() const;
	...
	private:
		...
		TOptional<FSoftClassPath> GetClassForPropertiesFromSelection(const TSet<FSoftObjectPath>& Objects) const;
