...
{
	ISubmissionOperation* FSubmissionWorkflow_RemoteClient::SubmitChanges()
	{
	...
	EChangeRevertability FSubmissionWorkflow_RemoteClient::GetRevertability() const
	{
		// TODO DP UE-180657: Changing remote client's stream is not implemented for now
		// TODO DP UE-198088 changing remote client authority
		return EChangeRevertability::NoChanges;
	}
}
