...
class PIXELSTREAMING2BLUEPRINT_API UPixelStreaming2StreamerComponent : public UActorComponent
{
...
public:
	...
	UPROPERTY(EditAnywhere, Category = "PixelStreaming2")
	TObjectPtr<UPixelStreaming2StreamerVideoProducer> VideoProducer = nullptr;
