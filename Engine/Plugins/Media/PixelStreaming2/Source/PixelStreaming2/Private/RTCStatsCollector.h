...
#if 0
	class PIXELSTREAMING2_API FRTCStatsCollector : public webrtc::RTCStatsCollectorCallback
	{
	public:
		FRTCStatsCollector();
		FRTCStatsCollector(FString PlayerId);
	...
	private:
		...
		*/
		...
		public:
			...
			virtual FString DerivePeerId(const webrtc::RTCStats& InStats, FString PlayerId) const { return PlayerId; }
		...
		*/
		...
		public:
			...
			virtual FString DerivePeerId(const webrtc::RTCStats& InStats, FString PlayerId) const override;
		private:
			FString MediaKind;
		};
