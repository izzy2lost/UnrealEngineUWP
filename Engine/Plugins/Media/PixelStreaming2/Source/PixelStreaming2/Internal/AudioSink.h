...
namespace UE::PixelStreaming2
{
	...
	public:
		...
		virtual void AddAudioConsumer(IPixelStreaming2AudioConsumer* AudioConsumer) override;
		virtual void RemoveAudioConsumer(IPixelStreaming2AudioConsumer* AudioConsumer) override;
