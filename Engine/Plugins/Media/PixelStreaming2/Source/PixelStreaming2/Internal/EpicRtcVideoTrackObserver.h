...
namespace UE::PixelStreaming2
{
	...
	class PIXELSTREAMING2_API FEpicRtcVideoTrackObserver : public EpicRtcVideoTrackObserverInterface, public TEpicRtcRefCountPtr<FEpicRtcVideoTrackObserver>
	{
	public:
	...
	public:
		...
		virtual uint32_t AddRef() override final { return TEpicRtcRefCountPtr<FEpicRtcVideoTrackObserver>::AddRef(); }
		virtual uint32_t Release() override final { return TEpicRtcRefCountPtr<FEpicRtcVideoTrackObserver>::Release(); }
		virtual uint32_t Count() const override final { return TEpicRtcRefCountPtr<FEpicRtcVideoTrackObserver>::GetRefCount(); }
