...
#define NANITE_VISUALIZE_PIXEL_PROGRAMMABLE_RASTER			32u
#define NANITE_VISUALIZE_PICKING							33u
#define NANITE_VISUALIZE_SHADING_WRITE_MASK					34u
#define NANITE_VISUALIZE_NO_DERIVATIVE_OPS					35u
#define NANITE_VISUALIZE_FAST_CLEAR_TILES					36u
