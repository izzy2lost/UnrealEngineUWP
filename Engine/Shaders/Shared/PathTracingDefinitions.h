...
#define PATH_TRACER_MAX_VOLUMES			3 // NOTE: Adjust _BIT constants below if this ever grows
...
#define PATH_TRACER_VOLUME_HOLDOUT_BIT						(8u)
...
#define PATH_TRACER_VOLUME_USE_ANALYTIC_TRANSMITTANCE       (64u)
