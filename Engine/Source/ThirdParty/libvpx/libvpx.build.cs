...
public class LibVpx : ModuleRules
{
	...
	public LibVpx(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		{
			PublicAdditionalLibraries.Add(Path.Combine(LibvpxLibraryPath, "Unix", Target.Architecture.LinuxName, "libvpx_fPIC.a"));
		}
		else if (Target.Platform == UnrealTargetPlatform.Mac)
		{
			PublicAdditionalLibraries.Add(Path.Combine(LibvpxLibraryPath, "Mac", "libvpx_fPIC.a"));
		}
