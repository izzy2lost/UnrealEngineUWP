...
Target::Target(Arch arch, const char *cpu, ISPCTarget ispc_target, bool pic, MCModel code_model, PICLevel pic_level, bool printTarget)
    : m_target(nullptr), m_targetMachine(nullptr), m_dataLayout(nullptr), m_valid(false), m_ispc_target(ispc_target),
      ...
      m_codeModel(code_model), m_picLevel(pic_level), m_maskingIsFree(false), m_maskBitCount(-1), m_hasHalfConverts(false),
