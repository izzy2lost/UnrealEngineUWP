...
// @EMMETTJNR_CHANGE : BEGIN UWP support
		...
		{
			PublicAdditionalLibraries.Add(Path.Combine(VorbisFileLibPath, Target.Platform.ToString(), "VS" + Target.WindowsPlatform.GetVisualStudioCompilerVersionName(), "libvorbisfile.lib"));
