...
public:
	...
	virtual TSharedPtr<SWidget> MakeEditUI(const FEditUIParameters& InParameters) = 0;
	...
	virtual FText GetDisplayText(const FUniversalObjectLocatorFragment* InFragment = nullptr) const = 0;
	...
	virtual FText GetDisplayTooltip(const FUniversalObjectLocatorFragment* InFragment = nullptr) const = 0;
	...
	virtual FSlateIcon GetDisplayIcon(const FUniversalObjectLocatorFragment* InFragment = nullptr) const = 0;
	...
	// Make a default fragment for the given fragment type
