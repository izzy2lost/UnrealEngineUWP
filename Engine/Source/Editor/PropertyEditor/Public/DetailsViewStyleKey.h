...
public:
	...
	/**
	 * The Classic Details View style used in Unreal Engine 5.0 and prior, which has Categories displayed with no
	 * padding between them and no built in horizontal space 
	 */
	static inline const PROPERTYEDITOR_API FDetailsViewStyleKey Classic{FName{"Classic"}};
	
	/**
	* A Details View style which presents with the top level Categories in a card-like fashion, with space between
	* and around them.
	*/
	static inline const PROPERTYEDITOR_API FDetailsViewStyleKey Card{FName{"Card"}};
	 ...
	 */
	static inline const PROPERTYEDITOR_API FDetailsViewStyleKey Default{FName{"Default"}};
