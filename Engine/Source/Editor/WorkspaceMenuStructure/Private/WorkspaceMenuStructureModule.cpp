...
public:
	...
	void ResetLevelEditorCategory()
	{
		...
		LevelEditorViewportsCategory = LevelEditorCategory->AddGroup("LevelEditorViewport", LOCTEXT("WorkspaceMenu_LevelEditorViewportCategory", "Viewports"), LOCTEXT( "WorkspaceMenu_LevelEditorViewportCategoryTooltip", "Open a Viewport tab." ), FSlateIcon(FAppStyle::Get().GetStyleSetName(), "LevelEditor.Tabs.Viewports"), true);
		LevelEditorDetailsCategory = LevelEditorCategory->AddGroup("LevelEditorDetail", LOCTEXT("WorkspaceMenu_LevelEditorDetailCategory", "Details" ), LOCTEXT("WorkspaceMenu_LevelEditorDetailCategoryTooltip", "Open a Details tab." ), FSlateIcon(FAppStyle::Get().GetStyleSetName(), "LevelEditor.Tabs.Details"), true );
		LevelEditorCinematicsCategory = LevelEditorCategory->AddGroup("LevelEditorCinematics", LOCTEXT("WorkspaceMenu_LevelEditorCinematicsCategory", "Cinematics"), LOCTEXT("WorkspaceMenu_LevelEditorCinematicsCategoryTooltip", "Open a Cinematics tab."), FSlateIcon(FAppStyle::Get().GetStyleSetName(), "LevelEditor.Tabs.Cinematics"), true);
		LevelEditorVirtualProductionCategory = LevelEditorCategory->AddGroup("LevelEditorVirtualProduction", LOCTEXT("WorkspaceMenu_LevelEditorVirtualProductionCategory", "Virtual Production"), LOCTEXT("WorkspaceMenu_LevelEditorVirtualProductionCategoryTooltip", "Open a Virtual Production tab."), FSlateIcon(FAppStyle::Get().GetStyleSetName(), "LevelEditor.Tabs.VirtualProduction"), true);
		LevelEditorModesCategory = LevelEditorCategory->AddGroup("LevelEditorTools", LOCTEXT("WorkspaceMenu_LevelEditorToolsCategory", "Editor Modes" ), FSlateIcon(FAppStyle::Get().GetStyleSetName(), "LevelEditor.Tabs.EditorModes"), true );
		LevelEditorWorldPartitionCategory = LevelEditorCategory->AddGroup("LevelEditorWorldPartition", LOCTEXT("WorkspaceMenu_LevelEditorWorldPartitionCategory", "World Partition"), LOCTEXT("WorkspaceMenu_LevelEditorWorldPartitionCategoryTooltip", "Open a World Partition tab."), FSlateIcon(FAppStyle::Get().GetStyleSetName(), "LevelEditor.Tabs.WorldPartition"), true);
		LevelEditorOutlinerCategory = LevelEditorCategory->AddGroup("LevelEditorOutliner", LOCTEXT("WorkspaceMenu_LevelEditorOutlinerCategory", "Outliner"), LOCTEXT("WorkspaceMenu_LevelEditorOutlinerCategoryTooltip", "Open an Outliner tab."), FSlateIcon(FAppStyle::GetAppStyleSetName(), "LevelEditor.Tabs.Outliner"), true);
	}
	...
	void ResetToolsCategory()
	{
		...
		DeveloperToolsSubMenuDebugCategory =     DeveloperToolsCategory->AddGroup("DeveloperToolsDebug", LOCTEXT("WorkspaceMenu_DeveloperToolsDebugCategory", "Debug"), FSlateIcon(FAppStyle::Get().GetStyleSetName(), "LevelEditor.Tabs.Debug"), true);

		DeveloperToolsDebugCategory = DeveloperToolsSubMenuDebugCategory->AddGroup("DebugTools", LOCTEXT("WorkspaceMenu_DeveloperToolsDebugCategory", "Debug"), FSlateIcon(), true);
		AutomationToolsCategory = DeveloperToolsSubMenuDebugCategory->AddGroup("TestingTools", LOCTEXT("WorkspaceMenu_AutomationToolsCategory", "Testing"), FSlateIcon(), true);

		DeveloperToolsProfilingCategory = DeveloperToolsCategory->AddGroup("DeveloperToolsProfiling", LOCTEXT("WorkspaceMenu_DeveloperToolsProfilingCategory", "Profile"),  FSlateIcon(FAppStyle::Get().GetStyleSetName(), "LevelEditor.Profile"), true);
		DeveloperToolsAuditCategory =     DeveloperToolsCategory->AddGroup("DeveloperToolsAudit", LOCTEXT("WorkspaceMenu_DeveloperToolsAuditCategory", "Audit"), FSlateIcon(FAppStyle::Get().GetStyleSetName(), "LevelEditor.Audit"), true);
		DeveloperToolsPlatformsCategory = DeveloperToolsCategory->AddGroup("DeveloperToolsPlatforms", LOCTEXT("WorkspaceMenu_DeveloperToolsPlatforms:WCategory", "Platforms"), FSlateIcon(FAppStyle::Get().GetStyleSetName(), "LevelEditor.Platforms"), true);
		DeveloperToolsMiscCategory =      DeveloperToolsCategory->AddGroup("DeveloperToolsMisc", LOCTEXT("WorkspaceMenu_DeveloperToolsMiscCategory", "Miscellaneous"), FSlateIcon(FAppStyle::Get().GetStyleSetName(), "LevelEditor.Tabs.Debug"), true);
	}
