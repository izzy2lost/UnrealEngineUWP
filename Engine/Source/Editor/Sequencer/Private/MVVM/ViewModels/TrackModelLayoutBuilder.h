...
public:
	...
	virtual void PushCategory( FName CategoryName, const FText& DisplayLabel, const FText& TooltipText, TFunction<TSharedPtr<UE::Sequencer::FCategoryModel>(FName, const FText&)> OptionalFactory ) override;
