...
class FSequencerTextFilterExpression_Selected : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_Selected(ISequencerTrackFilters& InFilterInterface);
	virtual ~FSequencerTextFilterExpression_Selected() override;
