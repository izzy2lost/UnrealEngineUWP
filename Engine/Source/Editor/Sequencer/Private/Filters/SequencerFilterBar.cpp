...
FSequencerFilterBar::FSequencerFilterBar(FSequencer& InSequencer)
	...
	, ClassTypeCategory(MakeShared<FFilterCategory>(LOCTEXT("ActorTypeFilterCategory", "Actor Type Filters"), LOCTEXT("ActorTypeFilterCategoryTooltip", "")))
	, ComponentTypeCategory(MakeShared<FFilterCategory>(LOCTEXT("ObjectTypeFilterCategory", "Object Type Filters"), LOCTEXT("ObjectTypeFilterCategoryTooltip", "")))
	, MiscCategory(MakeShared<FFilterCategory>(LOCTEXT("MiscFilterCategory", "Misc Filters"), LOCTEXT("MiscFilterCategoryTooltip", "")))
	, TransientCategory(MakeShared<FFilterCategory>(LOCTEXT("TransientFilterCategory", "Transient Filters"), LOCTEXT("TransientFilterCategoryTooltip", "")))
