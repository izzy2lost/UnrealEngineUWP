...
namespace EpicGames.Horde.Storage.Nodes
{
	...
	public class RedirectNode : Node 
	{
		...
		public RedirectNode(NodeReader reader) => Handle = reader.ReadBlobReference();
		...
		/// <inheritdoc/>
		public override void Serialize(NodeWriter writer) => writer.WriteBlobReference(Handle);
	}
}
