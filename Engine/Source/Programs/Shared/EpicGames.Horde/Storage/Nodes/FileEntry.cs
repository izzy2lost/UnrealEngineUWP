...
namespace EpicGames.Horde.Storage.Nodes
{
	...
	public sealed class FileEntry
	{
		...
		/// Constructor
		/// </summary>
		public FileEntry(string name, FileEntryFlags flags, long length, IoHash streamHash, ChunkedDataNodeRef target, DateTime modTime, ReadOnlyMemory<byte> customData)
		{
