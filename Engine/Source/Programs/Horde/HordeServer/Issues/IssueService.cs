...
namespace HordeServer.Issues
{
	...
	public sealed class IssueService : IHostedService, IAsyncDisposable
	{
		...
		/// Constructor
		/// </summary>
		public IssueService(IIssueCollection issueCollection, ICommitService commitService, IJobStepRefCollection jobStepRefs, IStreamCollection streams, IUserCollection userCollection, ILogCollection logCollection, IClock clock, IOptionsMonitor<GlobalConfig> globalConfig, Tracer tracer, ILogger<IssueService> logger)
		{
