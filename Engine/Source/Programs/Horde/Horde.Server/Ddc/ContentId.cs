...
namespace Horde.Server.Ddc
{
    ...
    public class ContentId : JupiterContentHash, IEquatable<ContentId>
    {
        ...
        public bool Equals(ContentId? other) => other != null && other.Identifier.AsSpan().SequenceEqual(Identifier);
        ...
        public static ContentId FromContentHash(JupiterContentHash contentHash)
        {
