...
namespace Horde.Server.Perforce
{
	...
	public static class PerforceWorkspace
	{
		...
		public static async Task<HashSet<AgentWorkspaceInfo>> GetWorkspacesAsync(this PoolService poolService, IAgent agent, DateTime validAtTime, GlobalConfig globalConfig, CancellationToken cancellationToken)
		{
