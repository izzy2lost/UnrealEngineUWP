...
namespace HordeServer.Artifacts
{
	...
	class ArtifactExpirationService : IHostedService
	{
		...
		public ArtifactExpirationService(IArtifactCollection artifactCollection, StorageService storageService, IOptionsMonitor<BuildConfig> buildConfig, IClock clock, ILogger<ArtifactExpirationService> logger)
		{
		...
		async ValueTask TickAsync(CancellationToken cancellationToken)
		{
			...
			foreach (ArtifactTypeConfig artifactType in buildConfig.ArtifactTypes)
			{
