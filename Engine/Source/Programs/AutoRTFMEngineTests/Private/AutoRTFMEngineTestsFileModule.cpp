...
class FAutoRTFMEngineTestsFile : public IPlatformFile
{
public:
	FAutoRTFMEngineTestsFile() : LowerLevel(nullptr) {}
	...
	virtual const TCHAR* GetName() const { return TEXT("AutoRTFMEngineTests"); }
...
class FAutoRTFMEngineTestsFileModule : public IPlatformFileModule
{
public:
	virtual IPlatformFile* GetPlatformFile() override
	{
		static TUniquePtr<IPlatformFile> AutoDestroySingleton = MakeUnique<FAutoRTFMEngineTestsFile>();
		return AutoDestroySingleton.Get();
	}
};

IMPLEMENT_MODULE(FAutoRTFMEngineTestsFileModule, AutoRTFMEngineTestsFile);
