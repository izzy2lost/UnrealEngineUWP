...
public:
	...
	FPipelineTestContext(const FName& SubsystemType)
	{
...
public:
	...
	bool AddPipeline(FTestPipeline&& Pipeline, const FPipelineTestContext& TestContext = FPipelineTestContext(NULL_SUBSYSTEM));
