...
public:
	...
	struct FBaseMeshInstance
	{
		...
		// Index of precomputed meshes for this instance, w.r.t. a pre-computed part meshes array
		// Note the pre-computed meshes array should be stored separately from the instance data,
		// and is provided as an argument to CombineMeshInstances.
		int32 PrecomputeMeshesIndex = -1;
	...
	// @param MeshInstances Instances to generate part meshes for. Indices into the ResultMeshSets array will also be assigned per instance
