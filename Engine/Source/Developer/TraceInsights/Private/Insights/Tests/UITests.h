...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FUnrealTraceServerStartingTest, "Insights.SessionBrowser.UnrealTraceServer.Startng", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)
