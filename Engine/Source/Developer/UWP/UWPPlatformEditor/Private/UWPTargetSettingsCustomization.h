...
private:
	...
	void AddWidgetForCapability(IDetailLayoutBuilder& DetailBuilder, TSharedRef<IPropertyHandle> PropertyHandle, TSharedRef<IPropertyHandle> CapabilityList, const FString& CapabilityName);
