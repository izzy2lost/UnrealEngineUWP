...
TMap<FGuid, FGuid> FFortniteMainBranchObjectVersion::GetSystemGuids()
{
	...
	SystemGuids.Add(DevGuids.NANITE_DERIVEDDATA_VER, FGuid("39D7717B44774DF698E6693CE64B443C"));
	...
	SystemGuids.Add(DevGuids.MaterialTranslationDDCVersion, FGuid("C42A7403BBDD420EBA946325D6F79B1B"));
	return SystemGuids;
}
