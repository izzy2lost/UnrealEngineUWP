...
TMap<FGuid, FGuid> FFortniteMainBranchObjectVersion::GetSystemGuids()
{
	...
	SystemGuids.Add(DevGuids.NIAGARASHADERMAP_DERIVEDDATA_VER, FGuid("7232E432BA8040DFB25048D86E632B3A"));
	SystemGuids.Add(DevGuids.Niagara_LatestScriptCompileVersion, FGuid("5761233C13C1441E9BBA7E381D8382FB"));
