 ...
 */
class FUWPInputInterface
	: public IInputInterface
{
public:

	static TSharedRef< FUWPInputInterface > Create( const TSharedRef< FGenericApplicationMessageHandler >& InMessageHandler );
...
private:
	...
	FUWPInputInterface( const TSharedRef< FGenericApplicationMessageHandler >& MessageHandler );
