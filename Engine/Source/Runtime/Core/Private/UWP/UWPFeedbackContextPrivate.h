...
/*=============================================================================
	UWPFeedbackContextPrivate.h: Unreal UWP user interface interaction.
=============================================================================*/
...
/**
 * Feedback context implementation for UWP.
 */
class FFeedbackContextUWP : public FFeedbackContext
{
