 ...
 *
 * Instantiation: Tracks any BoundMaterial with a MaterialParameterInfo, as well as deprecated ScalarParameterName, ColorParameterName or VectorParameterName.
 ...
 *
 * Evaluation:    Visits any BoundMaterial with the supported parameter infos/names and either a BlendChannelOutput component
