...
void ALandscapeProxy::PreSave(FObjectPreSaveContext ObjectSaveContext)
{
	...
	for (ULandscapeComponent* LandscapeComponent : LandscapeComponents)
	{
		...
		{
			UE_LOG(LogLandscape, Warning, TEXT("The component %s had incorrect bounds.  The bounds have been recalculated (old CachedLocalBox: %s, new CachedLocalBox: %s)"), *GetName(), *OldCachedLocalBox.ToString(), *LandscapeComponent->CachedLocalBox.ToString());
