...
USTRUCT()
struct COREUOBJECT_API FPropertyBagContainerTypes
{
	GENERATED_BODY()
...
USTRUCT()
struct COREUOBJECT_API FPropertyBagPropertyDescMetaData
{
	GENERATED_BODY()
...
USTRUCT()
struct COREUOBJECT_API FPropertyBagPropertyDesc
{
	GENERATED_BODY()
...
struct COREUOBJECT_API FInstancedPropertyBag
{
	 ...
	 */
	void AddProperty(const FName InName, const EPropertyBagPropertyType InValueType, const UObject* InValueTypeObject = nullptr);
	 ...
	 * @param InValueTypeObject Type object (for struct, class, enum) of the new property
	 */
	void AddContainerProperty(const FName InName, const EPropertyBagContainerType InContainerType, const EPropertyBagPropertyType InValueType, const UObject* InValueTypeObject = nullptr);
 ...
 * Note: The array reference is not valid after the layout of the referenced property bag has changed! 
 */
class COREUOBJECT_API FPropertyBagArrayRef : public FScriptArrayHelper
{
...
USTRUCT()
struct COREUOBJECT_API FPropertyBagMissingStruct
{
	GENERATED_BODY()
};

UCLASS()
class COREUOBJECT_API UPropertyBagMissingObject : public UObject
{
	GENERATED_BODY()
};
 ...
 */
UCLASS(Transient)
class COREUOBJECT_API UPropertyBag : public UScriptStruct
{
public:
	GENERATED_BODY()
