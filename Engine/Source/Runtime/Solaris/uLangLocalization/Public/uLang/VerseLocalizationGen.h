...
{
    ULANGLOCALIZATION_API void operator()(const uLang::CSemanticProgram& Program, uLang::CDiagnostics& Diagnostics, TArray<FSolLocalizationInfo>& LocalizationInfo) const;
};
}
