...
#undef VISIT_VSTNODE
    ...
    struct ULANGTOOLCHAINDEPENDENCIES_API Node : public CSharedMix
    {
    ...
    ULANGTOOLCHAINDEPENDENCIES_API const TSRef<Node> MakeStub(const SLocus& Whence);
    ...
    struct Package : public Node
    {
        ...
        ULANGTOOLCHAINDEPENDENCIES_API TSRef<Module> FindOrAddModule(const CUTF8StringView& ModuleName, const CUTF8StringView& ParentModuleName = CUTF8StringView());
        ULANGTOOLCHAINDEPENDENCIES_API static TOptional<TSRef<Module>> FindModule(const Node& ModuleContainer, const CUTF8StringView& ModuleName);
    };
    ...
    struct Project : public Node
    {
        ...
        ULANGTOOLCHAINDEPENDENCIES_API const TSRef<Module>& FindOrAddModule(const CUTF8StringView& ModuleName, const CUTF8StringView& FilePath, const CUTF8StringView& ParentModuleName = CUTF8StringView());
        ULANGTOOLCHAINDEPENDENCIES_API static TOptional<TSRef<Module>> FindModule(const Node& ModuleContainer, const CUTF8StringView& ModuleName);
         ...
         */
        ULANGTOOLCHAINDEPENDENCIES_API bool RemovePackagesWithName(const CUTF8StringView& PackageName)
        {
        ...
        ULANGTOOLCHAINDEPENDENCIES_API bool ReplaceSnippet(const CUTF8StringView& PathOfOldSnippetToReplace, TSRef<Snippet> NewSnippet, TSPtr<Snippet>* OutOldSnippet = nullptr)
        {
    ...
    struct BinaryOpAddSub : public BinaryOp
    {
        ...
        ULANGTOOLCHAINDEPENDENCIES_API void AppendAddOperation(const SLocus& AddWhence, const TSRef<Node>& RhsOperand);
        ULANGTOOLCHAINDEPENDENCIES_API void AppendSubOperation(const SLocus& SubWhence, const TSRef<Node>& RhsOperand);
    };
    ...
    struct BinaryOpMulDivInfix : public BinaryOp
    {
        ...
        ULANGTOOLCHAINDEPENDENCIES_API void AppendMulOperation(const SLocus& MulWhence, const TSRef<Node>& RhsOperand);
        ULANGTOOLCHAINDEPENDENCIES_API void AppendDivOperation(const SLocus& DivWhence, const TSRef<Node>& RhsOperand);
    };
    ...
    struct PrePostCall : public Node
    {
        ...
        ULANGTOOLCHAINDEPENDENCIES_API
 ...
 **/
ULANGTOOLCHAINDEPENDENCIES_API void VstAsCodeSourceAppend(const TSRef<Vst::Node>& VstNode, CUTF8StringBuilder& Source);
ULANGTOOLCHAINDEPENDENCIES_API void VstAsCodeSourceAppend(const TSRef<Vst::Node>& VstNode, const EPrettyPrintBehaviour Flags, CUTF8StringBuilder& Source);
ULANGTOOLCHAINDEPENDENCIES_API void VstAsCodeSourceAppend(const TSRef<Vst::PrePostCall>& VstNode, CUTF8StringBuilder& OutSource, int32_t FirstChildIndex, int32_t LastChildIndex);
ULANGTOOLCHAINDEPENDENCIES_API void VstAsCodeSourceAppend(const TSRef<Vst::Clause>& VstClause, CUTF8StringBuilder& OutSource, int32_t InitialIndent, CUTF8String const& Separator);
...
ULANGTOOLCHAINDEPENDENCIES_API bool GeneratePathToNode(const TSRef<Vst::Node>& Node, const TSRef<Vst::Snippet>& VstSnippet, SPathToNode& PathToNode);
ULANGTOOLCHAINDEPENDENCIES_API TSPtr<Vst::Node> GetNodeFromPath(const TSRef<Vst::Snippet>& VstSnippet, const SPathToNode& Path, bool bReturnParent=false);
 ...
 */
ULANGTOOLCHAINDEPENDENCIES_API int32_t GetSignedDistanceBetweenPositionAndLocus(const SLocus& A, const SPosition& B, const CUTF8StringView& SourceText);
