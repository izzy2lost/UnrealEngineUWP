 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CModule : public CDefinition, public CNominalType, public CLogicalScope, public CAstPackageRef
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CModulePart : public CScope, public TAstNodeRef<CExprModuleDefinition>, public CAstPackageRef
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CIntrinsicSymbols
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CCompatConstraintRoot : public CSharedMix, public CLogicalScope
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CSemanticProgram : public CSharedMix, public CLogicalScope
{
public:
// Public data members
