...
#define VERSE_VISIT_AST_NODE_TYPES(v) \
    ...
    v(Invoke_TupleType, CExprTupleType)                                 /* Get or create a tuple tuple based on `tuple(type1, type2, ...)` */ \
...
ULANGTOOLCHAINDEPENDENCIES_API SAstNodeTypeInfo GetAstNodeTypeInfo(uLang::EAstNodeType Type);
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CAstNode : public CSharedMix
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExpressionBase : public CAstNode, public CAttributable
{
public:
    ...
    virtual bool CanFail() const { return false; }

    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // Type methods
    virtual const CTypeBase* GetResultType(const CSemanticProgram& Program) const;
    void SetResultType(const CTypeBase* InResultType);
    void RefineResultType(const CTypeBase* RefinedResultType);
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprCompoundBase : public CExpressionBase
{
public:
    // Methods
    ...
    virtual bool CanFail() const override;
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprBinaryOp : public CExpressionBase
{
private:
    // Operands
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprExternal : public CExpressionBase
{
public:
    // Methods

    explicit CExprExternal(const CSemanticProgram& Program);
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprLogic : public CExpressionBase
{
public:

    bool _Value;

    explicit CExprLogic(const CSemanticProgram& Program, bool Value);
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprNumber : public CExpressionBase
{
private:
    union
    {
...
public:
    ...
    explicit CExprNumber(CSemanticProgram&, Integer);

    explicit CExprNumber(CSemanticProgram&, Float);
 ...
 * Character literal - 'H' '\n' '{0c00}' '{0u1f600}'
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprChar : public CExpressionBase
{
public:
    enum class EType
    {
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprString : public CExpressionBase
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprPath : public CExpressionBase
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprPathPlusSymbol : public CExpressionBase
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprIdentifierBase : public CExpressionBase
{
public:
    ...
    virtual bool CanFail() const override { return _Context.IsValid() && _Context->CanFail(); }
    virtual const CExpressionBase* FindFirstAsyncSubExpr(const CSemanticProgram& Program) const override
    {
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprEnumLiteral : public CExprIdentifierBase
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprType : public CExpressionBase
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprFunctionLiteral : public CExpressionBase
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprSelf : public CExprIdentifierBase
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CExprLocal : public CExprIdentifierBase
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprIdentifierBuiltInMacro : public CExprIdentifierBase
{
public:
    const CSymbol _Symbol;
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprIdentifierUnresolved : public CExprIdentifierBase
{
public:
    const CSymbol _Symbol;
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprIdentifierClass : public CExprIdentifierBase
{
public:

    CExprIdentifierClass(const CTypeType* Type, TSPtr<CExpressionBase>&& Context = nullptr, TSPtr<CExpressionBase>&& Qualifier = nullptr);

    const CTypeType* GetTypeType(const CSemanticProgram& Program) const;
    const CClass* GetClass(const CSemanticProgram& Program) const;
 ...
 * Module identifier
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprIdentifierModule : public CExprIdentifierBase
{
public:

    CExprIdentifierModule(const CModule* Module, TSPtr<CExpressionBase>&& Context = nullptr, TSPtr<CExpressionBase>&& Qualifier = nullptr);

    CModule const* GetModule(const CSemanticProgram& Program) const;
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprIdentifierModuleAlias : public CExprIdentifierBase
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprEnumerationType : public CExprIdentifierBase
{
public:
    ...
    const CTypeType* GetTypeType(const CSemanticProgram& Program) const;
    const CEnumeration* GetEnumeration(const CSemanticProgram& Program) const;
 ...
 * @jira SOL-1013 : Shouldn't this inherit from CExprIdentifierClass?
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprInterfaceType : public CExprIdentifierBase
{
public:
    ...
    const CInterface* GetInterface(const CSemanticProgram& Program) const;
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprIdentifierData : public CExprIdentifierBase
{
public:
    ...
    CExprIdentifierData(const CSemanticProgram& Program, const CDataDefinition& DataDefinition, TSPtr<CExpressionBase>&& Context = nullptr, TSPtr<CExpressionBase>&& Qualifier = nullptr);
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprIdentifierTypeAlias : public CExprIdentifierBase
{
public:
    ...
    CExprIdentifierTypeAlias(const CTypeAlias& TypeAlias, TSPtr<CExpressionBase>&& Context = nullptr, TSPtr<CExpressionBase>&& Qualifier = nullptr);
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprIdentifierTypeVariable : public CExprIdentifierBase
{
public:
    ...
    CExprIdentifierTypeVariable(const CTypeVariable& TypeVariable, TSPtr<CExpressionBase>&& Context = nullptr, TSPtr<CExpressionBase>&& Qualifier = nullptr);
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprIdentifierFunction : public CExprIdentifierBase
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprIdentifierOverloadedFunction : public CExprIdentifierBase
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprDefinition : public CExpressionBase
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CExprMacroCall : public CExpressionBase
{
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprInvocation : public CExpressionBase
{
public:
    ...
    CExprInvocation(EBracketingStyle CallsiteBracketStyle, TSRef<CExpressionBase>&& Callee, TSRef<CExpressionBase>&& Argument)
        : _CallsiteBracketStyle(CallsiteBracketStyle)
        , _Callee(Move(Callee))
        , _Argument(Move(Argument))
    {}

    CExprInvocation(EBracketingStyle CallsiteBracketStyle, const TSRef<CExpressionBase>& Callee, const TSRef<CExpressionBase>& Argument)
        : _CallsiteBracketStyle(CallsiteBracketStyle)
        , _Callee(Callee)
        , _Argument(Argument)
    {}
    ...
    CExprInvocation(EBracketingStyle CallsiteBracketStyle,
                    const TSRef<CExpressionBase>& Callee,
                    const TSRef<CExpressionBase>& Argument,
                    const CFunctionType* ResolvedCalleeType,
                    const CTypeBase* ResultType)
     : CExprInvocation(CallsiteBracketStyle, Callee, Argument)
    {
    ...
    const CFunctionType* GetResolvedCalleeType() const;
...
private:
    ...
    // Argument - possible a tuple of expressions, included named expressions
...
ULANGTOOLCHAINDEPENDENCIES_API const CExprIdentifierFunction* GetConstructorInvocationCallee(const CExprInvocation&);

ULANGTOOLCHAINDEPENDENCIES_API const CExprIdentifierFunction* GetConstructorInvocationCallee(const CExpressionBase&);

ULANGTOOLCHAINDEPENDENCIES_API bool IsConstructorInvocation(const CExprInvocation&);

ULANGTOOLCHAINDEPENDENCIES_API bool IsConstructorInvocation(const CExpressionBase&);

/**
 * Tuple element access `TupleExpr(Idx)`
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprTupleElement : public CExpressionBase
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprAssignment : public CExpressionBase
{
public:
    ...
    virtual bool CanFail() const override { return _Lhs->CanFail() || _Rhs->CanFail(); }
    virtual void VisitChildren(SAstVisitor& Visitor) const override { Visitor.Visit("Lhs", _Lhs); Visitor.Visit("Rhs", _Rhs); }
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprUnaryOp : public CExpressionBase
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CExprUnaryArithmetic : public CExprInvocation
{
public:
    enum class EOp
    {
...
private:
    ...
    virtual bool CanFail() const override { return false; }
...
class ULANGTOOLCHAINDEPENDENCIES_API CExprBinaryArithmetic : public CExprInvocation
{
public:
    enum class EOp
    {
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprShortCircuitAnd : public CExprBinaryOp
{
public:
    ...
    virtual bool CanFail() const override { return true; }
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprShortCircuitOr : public CExprBinaryOp
{
public:
    ...
    virtual bool CanFail() const override { return Rhs()->CanFail(); }
    virtual CUTF8String GetErrorDesc() const override    { return "logical '||'"; }
    virtual bool operator==(const CExpressionBase& Other) const override;
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprLogicalNot : public CExprUnaryOp
{
public:
...
*/
class ULANGTOOLCHAINDEPENDENCIES_API CExprComparison : public CExprInvocation
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprQueryValue : public CExprInvocation
{
public:
 ...
 * Box an option value
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprMakeOption : public CExprUnaryOp
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprMakeArray : public CExprCompoundBase
{
public:
 ...
 * Can have zero or more subexpressions
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprMakeMap : public CExprCompoundBase
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprMakeTuple : public CExprCompoundBase
{
public:
...
*/
class ULANGTOOLCHAINDEPENDENCIES_API CExprMakeRange : public CExpressionBase
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprInvokeType : public CExpressionBase
{
public:
    ...
    CExprInvokeType(const CTypeBase* NegativeType, const CTypeBase* PositiveType, bool bIsFallible, TSPtr<CExpressionBase>&& TypeAst, TSRef<CExpressionBase>&& Argument);

    //~ Begin CExpressionBase interface
    virtual const CExpressionBase* FindFirstAsyncSubExpr(const CSemanticProgram& Program) const override;
    virtual bool CanFail() const override { return _bIsFallible || _Argument->CanFail(); }
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprPointerToReference : public CExprUnaryOp
{
public:
    CExprPointerToReference(TSRef<CExpressionBase>&& Variable) : CExprUnaryOp(Move(Variable)) {}

    //~ Begin CExpressionBase interface
    virtual bool CanFail() const override { return Operand()->CanFail(); }
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprSet : public CExprUnaryOp
{
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprNewPointer : public CExpressionBase
{
public:
    ...
    //~ Begin CExpressionBase interface
    virtual bool CanFail() const override { return _Value->CanFail(); }
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprReferenceToValue : public CExprUnaryOp
{
public:
    CExprReferenceToValue(TSPtr<CExpressionBase>&& Operand);
 ...
 * Can have zero or more subexpressions
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprCodeBlock : public CExprCompoundBase
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CExprLet : public CExprCompoundBase
{
    using CExprCompoundBase::CExprCompoundBase;
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprReturn : public CExpressionBase
{
public:
    ...
    virtual bool CanFail() const override { return _Result.IsValid() && _Result->CanFail(); }
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprIf : public CExpressionBase
{
public:
 ...
 * Bounded iteration
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprIteration : public CExpressionBase
...
public:
    ...
    virtual const CExpressionBase* FindFirstAsyncSubExpr(const CSemanticProgram& Program) const override;
    virtual bool CanFail() const override { return _Body->CanFail(); }
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprConcurrentIteratedBase : public CExprIteration
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprSyncIterated : public CExprConcurrentIteratedBase
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprRushIterated : public CExprConcurrentIteratedBase
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprRaceIterated : public CExprConcurrentIteratedBase
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CExprTypeFormer : public CExpressionBase
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CExprUnaryTypeFormer : public CExprTypeFormer
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CExprArrayTypeFormer : public CExprUnaryTypeFormer
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CExprGeneratorTypeFormer : public CExprUnaryTypeFormer
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CExprMapTypeFormer : public CExprTypeFormer
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CExprOptionTypeFormer : public CExprUnaryTypeFormer
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CExprSubtype : public CExprUnaryTypeFormer
{
public:
    ...
    virtual CUTF8String GetErrorDesc() const override { return "subtype(..)"; }
    virtual bool operator==(const CExpressionBase& Other) const override { return false; }
    
    const CTypeType& GetSubtypeType() const;
};

// Get or create a tuple tuple based on `tuple(type1, type2, ...)`
class ULANGTOOLCHAINDEPENDENCIES_API CExprTupleType : public CExprTypeFormer
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprArrow : public CExprTypeFormer
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprArchetypeInstantiation : public CExpressionBase
{
public:
    CExprArchetypeInstantiation(TSRef<CExpressionBase>&& ClassAst, CExprMacroCall::CClause&& BodyAst, const CTypeBase* ResultType);
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprConcurrentBlockBase : public CExprCompoundBase
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprSync : public CExprConcurrentBlockBase
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprRace : public CExprConcurrentBlockBase
{
public:
 ...
 * no common type).
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprRush : public CExprConcurrentBlockBase
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprSubBlockBase : public CExpressionBase
{
protected:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprBranch : public CExprSubBlockBase
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprSpawn : public CExprSubBlockBase
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprLoop : public CExprSubBlockBase
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprDefer : public CExprSubBlockBase
{
public:
    virtual const CExpressionBase* FindFirstAsyncSubExpr(const CSemanticProgram& Program) const override { return _BlockExpr->FindFirstAsyncSubExpr(Program); }
 ...
 *       DoLoopStuff()
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CExprBreak : public CExpressionBase
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprSnippet : public CExpressionBase, public CMemberDefinitions
{
public:
    CUTF8String _Path;
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprModuleDefinition : public CExpressionBase, public CMemberDefinitions
{
public:
    CUTF8String _Name;
    ...
    CExprModuleDefinition(const CUTF8StringView& Name, EVstMappingType VstMappingType = EVstMappingType::Ast)
        ...
        , _Name(Name)
    {}
    CExprModuleDefinition(CModulePart& Module, TArray<TSRef<CExpressionBase>>&& Members);
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprEnumDefinition : public CExpressionBase
{
public:
    CEnumeration& _Enum;
    ...
    CExprEnumDefinition(CEnumeration& Enum, TArray<TSRef<CExpressionBase>>&& Members, EVstMappingType = EVstMappingType::Ast);
    ~CExprEnumDefinition();
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprScopedAccessLevelDefinition : public CExpressionBase
{
public:
    TSRef<CScopedAccessLevelDefinition> _AccessLevelDefinition;
    TArray<TSRef<CExpressionBase>> _ScopeReferenceExprs;

    CExprScopedAccessLevelDefinition(TSRef<CScopedAccessLevelDefinition>& AccessLevelDefinition, EVstMappingType VstMappingType = EVstMappingType::Ast);
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprInterfaceDefinition : public CExpressionBase, public CMemberDefinitions
{
public:
    ...
    CExprInterfaceDefinition(CInterface& Interface, TArray<TSRef<CExpressionBase>>&& SuperInterfaces, TArray<TSRef<CExpressionBase>>&& Members, EVstMappingType = EVstMappingType::Ast);
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprClassDefinition : public CExpressionBase, public CMemberDefinitions
{
public:
    CClass& _Class;
    
    CExprClassDefinition(CClass& Class, TArray<TSRef<CExpressionBase>>&& SuperTypes, TArray<TSRef<CExpressionBase>>&& Members, EVstMappingType = EVstMappingType::Ast);
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprDataDefinition : public CExprDefinition
{
public:
    const TSRef<CDataDefinition> _DataMember;

    CExprDataDefinition(const TSRef<CDataDefinition>& DataMember, TSPtr<CExpressionBase>&& Element, TSPtr<CExpressionBase>&& ValueDomain, TSPtr<CExpressionBase>&& Value, EVstMappingType = EVstMappingType::Ast);
    ~CExprDataDefinition();
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprIterationPairDefinition : public CExprDefinition
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CIrArrayAdd : public CExpressionBase
{
public:
    ...
    virtual bool CanFail() const override { return _Source->CanFail(); }
...
/// @see CIrArrayAdd
class ULANGTOOLCHAINDEPENDENCIES_API CIrMapAdd : public CExpressionBase
{
public:
    ...
    virtual bool operator==(const CExpressionBase&) const override;
    virtual const CExpressionBase* FindFirstAsyncSubExpr(const CSemanticProgram&) const override;
    virtual bool CanFail() const override;
    virtual void VisitChildren(SAstVisitor& Visitor) const override;
...
class ULANGTOOLCHAINDEPENDENCIES_API CIrArrayUnsafeCall : public CExpressionBase
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CIrConvertToDynamic : public CExprUnaryOp
{
public:
    CIrConvertToDynamic(const CTypeBase* ResultType, TSRef<CExpressionBase>&& Value);
 ...
 * Converts a value to a dynamically typed value. Only present in the IR, not the AST.
 */
class ULANGTOOLCHAINDEPENDENCIES_API CIrConvertFromDynamic : public CExprUnaryOp
{
public:
    CIrConvertFromDynamic(const CTypeBase* ResultType, TSRef<CExpressionBase>&& Value);
 ...
 * Bounded iteration
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CIrFor : public CExpressionBase
{
public:
    ...
    virtual const CExpressionBase* FindFirstAsyncSubExpr(const CSemanticProgram& Program) const override;
    virtual bool CanFail() const override { return _bCanFail; }
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CIrForBody : public CExpressionBase
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprFunctionDefinition : public CExprDefinition
{
public:
    const TSRef<CFunction> _Function;

    CExprFunctionDefinition(const TSRef<CFunction>& Function, TSPtr<CExpressionBase>&& Element, TSPtr<CExpressionBase>&& ValueDomain, TSPtr<CExpressionBase>&& Value, EVstMappingType = EVstMappingType::Ast);
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprTypeAliasDefinition : public CExprDefinition
{
public:
    const TSRef<CTypeAlias> _TypeAlias;

    CExprTypeAliasDefinition(const TSRef<CTypeAlias>& TypeAlias, TSPtr<CExpressionBase>&& Element, TSPtr<CExpressionBase>&& ValueDomain, TSPtr<CExpressionBase>&& Value, EVstMappingType = EVstMappingType::Ast);
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprUsing : public CExpressionBase
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprProfileBlock : public CExprSubBlockBase
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprImport : public CExpressionBase
{
public:
    const TSRef<CModuleAlias> _ModuleAlias;
    const TSRef<CExpressionBase> _Path;

    CExprImport(const TSRef<CModuleAlias>& ModuleAlias, TSRef<CExpressionBase>&& Path, EVstMappingType VstMappingType = EVstMappingType::Ast);
    ~CExprImport();
...
class ULANGTOOLCHAINDEPENDENCIES_API CExprWhere : public CExpressionBase
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CExprVar : public CExprUnaryOp
{
    using CExprUnaryOp::CExprUnaryOp;
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CExprMakeNamed : public CExpressionBase
{
public:
    ...
    virtual bool CanFail() const override
    {
        return _Value? _Value->CanFail() : false;
    }
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CAstPackage : public CAstNode, public CMemberDefinitions
{
public:
    CUTF8String _Name;
    ...
    bool CanSeeDefinition(const CDefinition& Definition) const;
};

/**
 * A group of packages that must be compiled as a unit (= a strongly connected component (SCC) in the dependency graph)
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CAstCompilationUnit : public CAstNode
{
public:
    ...
    EPackageRole GetRole() const;
    bool IsAllowNative() const;
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CAstProject : public CAstNode
{
public:
    ...
    const CAstPackage* FindPackageByName(const CUTF8String& PackageName) const;
    int32_t GetNumPackages() const;
