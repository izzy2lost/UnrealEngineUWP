...
ULANGTOOLCHAINDEPENDENCIES_API const char* TypeKindAsCString(ETypeKind Type);
...
class ULANGTOOLCHAINDEPENDENCIES_API CTypeBase
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CNormalType : public CTypeBase
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CTypeType : public CNormalType
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CNominalType : public CNormalType
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CInvariantValueType : public CNormalType
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CPointerType : public CInvariantValueType
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CReferenceType : public CInvariantValueType
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CValueType : public CNormalType
{
public:
 ...
 * Option type
 */
class ULANGTOOLCHAINDEPENDENCIES_API COptionType : public CValueType
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CArrayType : public CValueType
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CGeneratorType : public CValueType
{
public:
 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CMapType : public CNormalType
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CTupleType : public CNormalType
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CFunctionType : public CNormalType
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CFlowType : public CTypeBase
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CInstantiatedType : public CTypeBase
{
    virtual const CNormalType& GetNormalType() const override
    {
        if (!_NormalType)
...
class ULANGTOOLCHAINDEPENDENCIES_API CNamedType : public CValueType
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CIntType : public CNormalType
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CFloatType : public CNormalType
{
public:
...
{
    ULANGTOOLCHAINDEPENDENCIES_API const CClass* AsSingleClass(const CNormalType& NegativeType, const CNormalType& PositiveType);

    ULANGTOOLCHAINDEPENDENCIES_API const CInterface* AsSingleInterface(const CNormalType& NegativeType, const CNormalType& PositiveType);

    ULANGTOOLCHAINDEPENDENCIES_API TArray<STypeVariableSubstitution> Instantiate(const TArray<const CTypeVariable*>& TypeVariables);

    ULANGTOOLCHAINDEPENDENCIES_API const CTypeBase* Substitute(const CTypeBase&, ETypePolarity Polarity, const TArray<STypeVariableSubstitution>& InstTypeVariables);

    ULANGTOOLCHAINDEPENDENCIES_API const CFunctionType* Instantiate(const CFunctionType*);
    ...
    ULANGTOOLCHAINDEPENDENCIES_API const CTypeBase& Canonicalize(const CTypeBase&);

    ULANGTOOLCHAINDEPENDENCIES_API const CFunctionType& Canonicalize(const CFunctionType&);

    ULANGTOOLCHAINDEPENDENCIES_API const CTupleType& Canonicalize(const CTupleType&);

    ULANGTOOLCHAINDEPENDENCIES_API const CTypeBase& AsPolarity(const CTypeBase&, const TArray<SInstantiatedTypeVariable>&, ETypePolarity);
    ULANGTOOLCHAINDEPENDENCIES_API const CTypeBase& AsPositive(const CTypeBase&, const TArray<SInstantiatedTypeVariable>&);
    ULANGTOOLCHAINDEPENDENCIES_API const CTypeBase& AsNegative(const CTypeBase&, const TArray<SInstantiatedTypeVariable>&);

    /// Constrain `PositiveType1` to be a subtype of `NegativeType2`
    ULANGTOOLCHAINDEPENDENCIES_API bool Constrain(const CTypeBase* PositiveType1, const CTypeBase* NegativeType2);

    /// Determine if `PositiveType1` is a subtype of `PositiveType2`
    ULANGTOOLCHAINDEPENDENCIES_API bool IsSubtype(const CTypeBase* PositiveType1, const CTypeBase* PositiveType2);
    
    /// Determine if `PositiveType1` is equivalent to `PositiveType2`
    ULANGTOOLCHAINDEPENDENCIES_API bool IsEquivalent(const CTypeBase* PositiveType1, const CTypeBase* PositiveType2);

    /// Determine if argument `PositiveType1` is a match for parameter `NegativeType2`
    ULANGTOOLCHAINDEPENDENCIES_API bool Matches(const CTypeBase* PositiveType1, const CTypeBase* NegativeType2);

    ULANGTOOLCHAINDEPENDENCIES_API const CTypeBase& SkipIdentityFlowType(const CFlowType&, ETypePolarity);

    ULANGTOOLCHAINDEPENDENCIES_API const CTypeBase& SkipIdentityFlowType(const CTypeBase&, ETypePolarity);

    ULANGTOOLCHAINDEPENDENCIES_API const CTypeBase& SkipEmptyFlowType(const CTypeBase&);

    /// Compute the join of Type1 and Type2: the "least" type that contains all values contained by either Type1 or Type2.
    ULANGTOOLCHAINDEPENDENCIES_API const CTypeBase* Join(const CTypeBase* Type1, const CTypeBase* Type2);

    /// Compute the meet of Type1 and Type2: the "greatest" type that contains only values contained by both Type1 and Type2.
    ULANGTOOLCHAINDEPENDENCIES_API const CTypeBase* Meet(const CTypeBase* Type1, const CTypeBase* Type2);

    /// Determine whether there two types are distinct; i.e. that there are no values that are members of both types.
    ULANGTOOLCHAINDEPENDENCIES_API bool AreDomainsDistinct(const CTypeBase* DomainType1, const CTypeBase* DomainType2);

    ULANGTOOLCHAINDEPENDENCIES_API bool IsUnknownType(const CTypeBase* Type);

    ULANGTOOLCHAINDEPENDENCIES_API bool IsAttributeType(const CTypeBase* Type);

    ULANGTOOLCHAINDEPENDENCIES_API void VisitAllDefinitions(const CTypeBase* Type, const TFunction<void(const CDefinition&,const CSymbol&)>& Functor);
    ...
    ULANGTOOLCHAINDEPENDENCIES_API void ForEachDataType(const CTypeBase*, const TFunction<void(const CTypeBase*)>&);

    /// `ForEachDataType`, but recursive, and depth-first, top-down, including
    /// the immediately passed type.
    ULANGTOOLCHAINDEPENDENCIES_API void ForEachDataTypeRecursive(const CTypeBase*, const TFunction<void(const CTypeBase*)>&);
    ...
    ULANGTOOLCHAINDEPENDENCIES_API const char* IsEditableToCMessage(EIsEditable IsEditable);
    ULANGTOOLCHAINDEPENDENCIES_API EIsEditable IsEditableType(const uLang::CTypeBase* Type, bool bAllowNonConcreteClasses);
}
