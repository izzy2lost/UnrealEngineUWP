...
ULANGTOOLCHAINDEPENDENCIES_API TRangeView<SEffectInfo*, SEffectInfo*> AllEffectInfos();
ULANGTOOLCHAINDEPENDENCIES_API SEffectInfo GetEffectInfo(EEffect Effect);
