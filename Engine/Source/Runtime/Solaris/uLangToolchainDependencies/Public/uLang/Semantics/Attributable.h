...
ULANGTOOLCHAINDEPENDENCIES_API bool IsAttributeHack(const SAttribute&, const CClass* AttributeClass, const CSemanticProgram&);
ULANGTOOLCHAINDEPENDENCIES_API bool IsAttributeHack(const SAttribute&, const CFunction* AttributeFunction, const CSemanticProgram&);
...
class ULANGTOOLCHAINDEPENDENCIES_API CAttributable
{
public:
