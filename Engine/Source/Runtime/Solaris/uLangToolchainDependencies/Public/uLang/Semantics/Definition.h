 ...
 */
class ULANGTOOLCHAINDEPENDENCIES_API CDefinition : public CAttributable, public CNamed, public TAstNodeRef<CExpressionBase>, public CSharedMix
{
public:
...
ULANGTOOLCHAINDEPENDENCIES_API CUTF8String GetQualifiedNameString(const CDefinition& Definition);
ULANGTOOLCHAINDEPENDENCIES_API const char* DefinitionKindAsCString(CDefinition::EKind Kind);
