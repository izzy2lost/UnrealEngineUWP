 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CEnumerator : public CDefinition
{
public:
 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CEnumeration : public CDefinition, public CLogicalScope, public CNominalType
{
public:
