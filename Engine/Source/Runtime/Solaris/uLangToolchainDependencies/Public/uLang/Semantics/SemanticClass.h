 ...
 **/
class ULANGTOOLCHAINDEPENDENCIES_API CClass : public CNominalType, public CLogicalScope
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CClassDefinition : public CDefinition, public CClass
{
public:
...
class ULANGTOOLCHAINDEPENDENCIES_API CInstantiatedClass : public CInstantiatedType
{
public:
...
ULANGTOOLCHAINDEPENDENCIES_API CClass* InstantiateClass(const CClass&, ETypePolarity, const TArray<STypeVariableSubstitution>&);

ULANGTOOLCHAINDEPENDENCIES_API void SetNegativeClassMemberDefinitionTypes(const CClass& PositiveClass);
