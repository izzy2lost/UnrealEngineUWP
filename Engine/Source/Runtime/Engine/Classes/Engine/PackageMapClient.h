...
public:
	...
	virtual void AddUnmappedNetGUIDReference(FNetworkGUID UnmappedGUID) override;
	virtual void RemoveUnmappedNetGUIDReference(FNetworkGUID MappedGUID) override;
