...
public:
	...
	ENGINE_API FORCEINLINE bool IsLooping() const
	{
	...
	ENGINE_API FORCEINLINE float GetSampleRate() const
	{
		return SampleRate;
	}

	ENGINE_API FORCEINLINE int32 GetNumChannels() const
	{
		return NumChannels;
	}

	/** Returns the index of the playhead within the complete wave. */
	ENGINE_API FORCEINLINE int32 GetFrameIndex() const
	{
		return CurrentFrameIndex;
	}

	ENGINE_API FORCEINLINE int32 GetNumFramesInWave() const
	{
		return NumFramesInWave;
	}

	ENGINE_API FORCEINLINE int32 GetNumFramesInLoop() const
	{
		return LoopEndFrameIndex - LoopStartFrameIndex;
	}

	ENGINE_API FORCEINLINE int32 GetLoopStartFrameIndex() const
	{
		return LoopStartFrameIndex;
	}

	ENGINE_API FORCEINLINE int32 GetLoopEndFrameIndex() const
	{
