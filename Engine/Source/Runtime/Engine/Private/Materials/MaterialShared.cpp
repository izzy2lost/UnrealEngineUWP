...
bool bIsUsingNewMaterialTranslatorPrototype;
static FAutoConsoleVariableRef CVarUsingUseNewMaterialTranslatorPrototype(
	TEXT("r.MaterialEditor.UseNewTranslatorPrototype"),
	bIsUsingNewMaterialTranslatorPrototype,
