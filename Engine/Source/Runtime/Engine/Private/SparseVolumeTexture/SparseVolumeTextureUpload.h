...
public:
	...
	void Release();
	void ResourceUploadTo(FRDGBuilder& InGraphBuilder, FRHITexture* InDstTextureA, FRHITexture* InDstTextureB, const FVector4f& InFallbackValueA, const FVector4f& InFallbackValueB);
...
public:
	...
	void Add_GetRef(FRHITexture* InPageTable, int32 InMipLevel, int32 InNumUpdates, uint8*& OutCoordsPtr, uint8*& OutPayloadPtr);
	void Release();
