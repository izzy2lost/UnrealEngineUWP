...
namespace Chaos
{
	namespace Collisions
	{
		...
		inline bool UseCCDImpl(const TGeometryParticleHandle<FReal, 3>* SweptParticle, const TGeometryParticleHandle<FReal, 3>* OtherParticle, const FImplicitObject* SweptImplicit, const FVec3& SweptX, const FVec3& SweptP, FVec3& Dir, FReal& Length)
		{
		...
		inline bool UseCCD_Init(const TGeometryParticleHandle<FReal, 3>* SweptParticle, const TGeometryParticleHandle<FReal, 3>* OtherParticle, const FImplicitObject* Implicit, FVec3& Dir, FReal& Length)
		{
			return UseCCDImpl(SweptParticle, OtherParticle, Implicit, FConstGenericParticleHandle(SweptParticle)->X(), FConstGenericParticleHandle(SweptParticle)->P(), Dir, Length);
		}
		...
		inline bool UseCCD_Update(FPBDCollisionConstraint& Constraint, FVec3& Dir, FReal& Length)
		{
			...
			{
				return UseCCDImpl(Constraint.Particle[0], Constraint.Particle[1], Constraint.GetManifold().Implicit[0], Constraint.GetSolverBody0()->X(), Constraint.GetSolverBody0()->P(), Dir, Length);
			}
			return false;
		}
		...
		inline void UpdateConstraintFromGeometrySweptImpl(FPBDCollisionConstraint& Constraint, const FRigidTransform3& WorldTransform0, const FRigidTransform3& WorldTransform1, const FReal Dt)
		{
			...
			FVec3 DirCCD(0.0f);
			bool bUseCCD = UseCCD_Update(Constraint, DirCCD, LengthCCD);
		...
		void ConstructConstraintsImpl(TGeometryParticleHandle<FReal, 3>* Particle0, TGeometryParticleHandle<FReal, 3>* Particle1, const FImplicitObject* Implicit0, const FBVHParticles* Simplicial0, const FImplicitObject* Implicit1, const FBVHParticles* Simplicial1, const FRigidTransform3& ParticleWorldTransform0, const FRigidTransform3& LocalTransform0, const FRigidTransform3& ParticleWorldTransform1, const FRigidTransform3& LocalTransform1, const FReal CullDistance, const FReal Dt, const FCollisionContext& Context)
		{
			...
			FReal LengthCCD = 0.0f;
			FVec3 DirCCD(0.0f);
			bool bUseCCD = UseCCD_Init(Particle0, Particle1, Implicit0, DirCCD, LengthCCD);
