...
{
	ManagedArrayCollectionPinTypeColor = Dataflow::Private::CManagedArrayCollectionPinTypeColor;
	ArrayPinTypeColor = Dataflow::Private::CArrayPinTypeColor;
	BoxPinTypeColor = Dataflow::Private::CBoxPinTypeColor;
	SpherePinTypeColor = Dataflow::Private::CSpherePinTypeColor;
	DataflowAnyTypePinTypeColor = Dataflow::Private::CDataflowAnyTypePinTypeColor;
}
