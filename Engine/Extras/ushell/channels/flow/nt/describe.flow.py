...
fd.version("8.7.1")
fd.payload("https://github.com/sharkdp/fd/releases/download/v8.7.1/fd-v8.7.1-x86_64-pc-windows-msvc.zip")
...
fzf_win32.payload("https://github.com/junegunn/fzf/releases/download/0.44.1/fzf-0.44.1-windows_amd64.zip")
